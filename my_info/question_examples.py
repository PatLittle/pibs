    ...
    "q_business_supplier": QuestionHelp(
        ...
        (
            ...
            InteractionExample(
                "Transport Canada",
                "Transports Canada",
                "Applying for a civil aviation personnel licence",
                "Demander une licence de membre du personnel de l'aviation civile",
                ("TC PPU 005",),
            ),
        ),
        "Use named child routes for contracting, aviation and other regulatory interactions. Firearms and boating are asked separately.",
        "Utiliser des parcours secondaires nommés pour les marchés, l'aviation et les autres interactions réglementaires. Les armes à feu et la navigation sont demandées séparément.",
    ),
    "q_firearms": QuestionHelp(
        "common",
        (
            InteractionExample(
                "Royal Canadian Mounted Police / Canadian Firearms Program",
                "Gendarmerie royale du Canada / Programme canadien des armes à feu",
                "Applying for or renewing a Possession and Acquisition Licence",
                "Demander ou renouveler un permis de possession et d'acquisition",
                ("RCMP PPU 007", "RCMP PPU 100"),
            ),
            InteractionExample(
                "Royal Canadian Mounted Police / Canadian Firearms Program",
                "Gendarmerie royale du Canada / Programme canadien des armes à feu",
                "Registering a restricted firearm",
                "Enregistrer une arme à feu à autorisation restreinte",
                ("RCMP PPU 037", "RCMP PPU 101"),
            ),
        ),
        "The licence and registration routes can both apply, but their PIB coverage differs.",
        "Les parcours liés au permis et à l'enregistrement peuvent tous deux s'appliquer, mais leur couverture des FRP diffère.",
    ),
    "q_boating": QuestionHelp(
        "mixed",
        (
            InteractionExample(
                "Transport Canada",
                "Transports Canada",
                "Getting a Pleasure Craft Operator Card after boating-safety training",
                "Obtenir une carte de conducteur d'embarcation de plaisance après une formation en sécurité nautique",
                ("TC PPU 023",),
            ),
            InteractionExample(
                "Transport Canada",
                "Transports Canada",
                "Licensing or registering a boat",
                "Obtenir un permis ou une immatriculation pour un bateau",
                ("TC PPU 041", "TC PPU 044"),
            ),
        ),
        "Keep operator cards, pleasure-craft licences and vessel registration as separate child routes because the records and retention rules differ.",
        "Séparer les cartes de conducteur, les permis d'embarcation de plaisance et l'immatriculation des bâtiments, car les dossiers et règles de conservation diffèrent.",
    ),

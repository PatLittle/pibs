...
* [Français](/fr/regie/gouvernement-ouvert/transparence/demandes-acces-information-completees/info-source.html)

[![](/global/images/logo_cer_en.png)
 Canada Energy Regulator / Régie de l’énergie du Canada](/en/index.html)
...
* [Safety and environment](/en/safety-environment/index.html)
* [Consultation and engagement](/en/consultation-engagement/index.html)
* [Applications and hearings](/en/applications-hearings/index.html)
* [Data and analysis](/en/data-analysis/index.html)
* [About Us](/en/about/index.html)

## You are here:

1. [Home](/en/index.html)
2. [About Us](/en/about/index.html)
3. [Open Government](/en/about/open-government/index.html)
4. [Transparency](/en/about/open-government/transparency/index.html)
5. Info Source

# Info Source

[Info Source - Sources of Federal Government and Employee Information [PDF 744 KB]](/en/about/open-government/transparency/completed-access-information-requests/info-source.pdf "Info Source - Sources of Federal Government and Employee Information")
...
* [General Information](#s1)
  + [Introduction to Info Source](#s1_1)
  + [Background](#s1_2)
  + [Responsibilities](#s1_3)
* [Institutional programs and activities](#s2)
  + [Energy Adjudication](#s2_1)
    - [Infrastructure, Tolls and Export Applications](#s2_1_1)
    - [Participant Funding](#s2_1_2)
  + [Safety and Environment Oversight](#s2_2)
    - [Company Performance](#s2_2_1)
    - [Management Systems and Industry Performance](#s2_2_2)
    - [Emergency Management](#s2_2_3)
    - [Regulatory Framework](#s2_2_4)
  + [Energy Information](#s2_3)
    - [Energy System Information](#s2_3_1)
    - [Pipeline Information](#s2_3_2)
  + [Engagement](#s2_4)
    - [Stakeholder Engagement](#s2_4_1)
    - [Indigenous Engagement](#s2_4_2)
    - [Crown Consultation](#s2_4_3)
    - [Dispute Resolution](#s2_4_4)
  + [Internal Services](#s2_5)
  + [Classes of Personal Information](#s2_6)
  + [Manuals](#s2_7)
  + [Additional Information](#s2_8)
    - [Reading Room](#s2_8_1)
...
* [About Us](/en/about/)
* [Who we are and what we do](/en/about/who-we-are-what-we-do/)
* [The CER’s history](/en/about/who-we-are-what-we-do/our-history.html)
* [The CER’s legislative foundation and how it reports to Parliament](/en/about/acts-regulations/)

### Responsibilities

* [The CER’s mandate](/en/about/who-we-are-what-we-do/governance/governance-canada-energy-regulator-mandate-roles-responsibilities/index.html#s2)
* [The CER’s responsibilities](/en/about/who-we-are-what-we-do/responsibility/)
* [The CER’s organization and structure](/en/about/who-we-are-what-we-do/organization-structure/)
* [The CER’s Governance](/en/about/who-we-are-what-we-do/governance/)
* [Fact Sheets about the CER](/en/about/news-room/fact-sheets/)
...
* **Certificates, Licences, Authorizations, Approvals and Orders Class of Record
  ...
  **Disclosure Summaries:** No third-party disclosure or information sharing has occurred. All final letters and orders are available on the CER website.  **Record Number:** CER-3205136
* **Public Hearing Process Class of Record
  Description:**Includes records related to the public hearing process facilitated by the CER before the Commission decides on an application for a major project. Stakeholder opinions can be gathered in writing or through a combination of written and oral submissions. Most of the information collected under this initiative will be available for public view on the [CER website](/index.html). After the close of the public hearing, the CER will either issue Reasons for Decision or a CER Report.
  ...
  **Record Number:**CER-3429839, CER-3209953, CER-3430330, CER-3424484, CER-3430021, CER-3425295, CER-3430873, and CER-4467834
...
* **Export and Import Applications for Oil, Gas, NGLs and Refined Petroleum Products Class of Record
  ...
  **Disclosure Summaries:** No third-party disclosure or information sharing has occurred.  All publicly available information is posted on the CER website.
  **Record Number:** CER-3424484 and CER-3430021
...
* **Frontier and Offshore – Operating Licence Class of Record
  ...
  **Record Number:** CER-3452510
* **Onshore and Offshore Frontier – Geological Operations Class of Record****Description:** Includes records related to applications for geological activities on frontier lands and offshore areas under  COGOA and  OGOA.  Geological activities mean “work, in the field or laboratory, involving the collection, examination, processing or other analysis of lithological, paleontological or geochemical materials recovered from the surface or subsurface or the seabed or is subsoil on any frontier lands and includes the analysis and interpretation of mechanical well logs”.  These applications have been processed by the CER since 1991.
...
* **Active Facility Operations Class of Record
  ...
  **Disclosure Summaries:** No third-party disclosure or information sharing has occurred. **Record Number:** CER-3426224
* **Traffic, Tolls and Tariffs Class of Record
  ...
  **Disclosure Summaries:** No third-party disclosure or information sharing has occurred.  All publicly available information is posted on the CER website.
  **Record Number:** CER-3430873
* **Damage Prevention Cost Apportionment Class of Record
...
* **Accountable Officer and Annual Report Class of Record****Description:** Includes records related to the submissions (by a regulated company) of the name and designation of an Accountable Officer under section 6.2 (1) *Onshore Pipeline Regulations* (OPR) and on an annual basis submit a report that demonstrates the company has met the requirements of the management system and the company’s obligations under the OPR.
  ...
  **Record Number:** CER-3410220
* **Administrative Monetary Penalties Class of Record****Description:** Includes records related to Administrative Monetary Penalties (AMPs) imposed by the CER on companies or individuals for non-compliance with legislation, regulations, decisions, permits, orders, licenses or certificate conditions under Section 115 of the CER Act and the *Administrative Monetary Penalties Regulations* (AMPs Regulations).
...
* **Class Location and Safety (Class) Class of Record****Description:** Includes records related to notifications of changes to class location or safety class in accordance with CSA Z662, section 42 of CER OPR and CER Order MO-15-2023.  Both methods look at safety factors companies need to consider for pipeline projects such as their approximate population density and other characteristics that are considered when designing and pressure testing pipeline to be located in the area.
  ...
  **Disclosure Summaries:** No third-party disclosure or information sharing has occurred.
  **Record Number:** CER-3427050
* **Damage Prevention Class of Record****Description**: Includes records related to violations of the CER *Damage Prevention Regulations* (DPR) – Obligations by Pipeline Companies, by third parties. Such violations include, but are not limited to, permission not being sought before crossing or digging near a regulated pipeline as well as damage incurred to the pipeline or right-of-way.
...
* **Enforcement Class of Record****Description**: Includes records related to enforcement actions taken against regulated companies to bring them back into compliance and operating safely.  Enforcement actions can take the form of a notice of non-compliance, inspection officer orders, administrative monetary penalties, warning letters, Commission orders or letters of direction, revoking or suspending authorizations and prosecution.
  ...
  **Disclosure Summaries**: No third-party disclosure or information sharing has occurred.  Reports on compliance and enforcement are posted on the CER website.
  **Record Number**: CER-3425464
* **Incidents Class of Record****Description:** Includes records related to pipeline and oil and gas activities or facilities incidents and any subsequent reports on repairs and remedial action under the CER Act, the COGO Act and the OGO Act.
  ...
  **Disclosure Summaries:** No third-party disclosure or information sharing has occurred. **Record Number:** CER-3425682
* **Inspections and Compliance Verification Class of Record****Description:** Includes records related to inspections, compliance meetings, report reviews under the CER Act: CER DPR – Authorizations and CER DPR – Obligations of Pipeline Companies, CER OPR; under the COGO Act and the OGO Act: Canada Oil and Gas Drilling and Production Regulations, Canada Oil and Gas Geophysical Operations Regulations; and Canada Labour Code activities. In addition, also includes Proposed Regulatory Change 2010-01 of facilities during and after oil and gas exploration and production activities, facilities construction, and facilities that have been placed in service.
...
* **Operation and Maintenance Activities Class of Record****Description**: Includes records related to routine operation and maintenance activities by regulated companies.  These include activities necessary to safely operate the existing pipeline, maintenance activities, upgrades or repairs to an existing pipeline or part of a pipeline that does not increase the approved maximum operating pressure (MOP), the stress level or diameter of the pipeline or physically removing an existing section of pipe up to 5 km in length and putting a new section of pipe in its place if the replacement does not increase the existing MOP, stress level or diameter of pipeline.
  ...
  **Record Number**: CER-3426391
* **Notice of Contamination Class of Record****Description:** Includes records related to reported contamination and remediation. Companies are required to demonstrate they are effectively anticipating, preventing, managing and mitigating adverse effects of contamination related to their facilities.
...
* **Management System Audits Class of Record
  ...
  **Disclosure Summaries:** No third-party disclosure or information sharing has occurred. **Record Number:** CER-3426490
...
* **Regulatory Communications Class of Record
  ...
  **Disclosure Summaries:** No third-party disclosure or information sharing has occurred. **Record Number:** CER-2879329
...
* **Onshore and Offshore Frontier Exploration and Production Class of Record
  ...
  **Disclosure Summaries:** No third-party disclosure or information sharing has occurred. **Record Number:** Information is available through the Frontier Information Office
...
* **Engagement Class of Record
  ...
  **Disclosure Summaries:** No third-party disclosure or information sharing has occurred. **Record Number:** CER-3069187
...
* **Consultation with Indigenous Groups Class of Record****Description:** Includes records related to discussions with Indigenous groups with respect to energy regulation and activities that directly or indirectly affect the traditional rights, land and/or people of designated Indigenous groups.
...
The CER’s consultation with Indigenous Peoples is guided by the [United Nations Declaration on the Rights of Indigenous Peoples (UNDRIP)](https://www.justice.gc.ca/declaration.html) and the UN Declaration Act. In addition, the CER follows the guidance in the [Calls To Action of](https://rcaanc-cirnac.gc.ca/eng/1524494530110/1557511412801) the [Truth and Reconciliation Commission](https://www.rcaanc-cirnac.gc.ca/eng/1450124405592/1529106060525), and the [Principles respecting the Government of Canada’s relationship with Indigenous Peoples](https://justice.gc.ca/eng/csj-sjc/principles-principes.html) as well as case law and federal guidance on the [duty to consult](https://www.rcaanc-cirnac.gc.ca/eng/1331832510888/1609421255810).

* **Crown Consultation Class of Record****Description**: Information related to interactions between the Crown Consultation Coordinator and Indigenous Peoples across Canada who may be affected by facilities regulated by the CER.  The Crown Consultation Coordinator works independently from the Commission and remains neutral in all its interactions about proposed projects.
...
* **Complaint Resolution Class of Record****Description**: Includes records related to an issue or concern that landowners, First Nations or affected parties have with a company that they have been unable to resolve by any other means.
...
* [Compensation and Benefits Class of Record](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/access-information/information-about-programs-information-holdings/standard-classes-records.html#prn941)
  + [Attendance and Leave](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/access-information/information-about-programs-information-holdings/standard-personal-information-banks.html#pse903)
  + [Pay and Benefits](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/access-information/information-about-programs-information-holdings/standard-personal-information-banks.html#pse904)
...
* [Canadian Human Rights Act – Complaints](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/access-information/information-about-programs-information-holdings/standard-personal-information-banks.html#psu933)
...
* [Access to Information and Privacy](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/access-information/information-about-programs-information-holdings/standard-classes-records.html#prn930)
...
* [Information Technology Class of Record](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/access-information/information-about-programs-information-holdings/standard-classes-records.html#prn932)
  + [Electronic Network Monitoring Logs Personal Information Bank](https://www.canada.ca/en/treasury-board-secretariat/services/access-information-privacy/access-information/information-about-programs-information-holdings/standard-personal-information-banks.html#psu905)
...
* [Administrative Monetary Penalties Process Guide](/en/about/acts-regulations/cer-act-regulations-guidance-notes-related-documents/administrative-monetary-penalties/process-guide/)
* [Administrative Monetary Penalties: Information for Landowners](/en/about/acts-regulations/cer-act-regulations-guidance-notes-related-documents/administrative-monetary-penalties/information-landowners/)
* [Agricultural Activities Near Pipelines](/en/safety-environment/damage-prevention/agricultural-activities/agricultural-activities-near-pipelines/)
* [Electricity Filing Manual](/en/applications-hearings/submit-applications-documents/filing-manuals/electricity-filing-manual/)
* [Construction Near Pipelines](/en/safety-environment/damage-prevention/contractors/construction-near-pipelines/)
* [Filing Manual](/en/applications-hearings/submit-applications-documents/filing-manuals/filing-manual/) (this manual has been developed to provide direction regarding the information the CER would typically expect to see addressed in a filing)
* [Filing Requirements for Offshore Drilling in the Canadian Arctic](/en/about/acts-regulations/other-acts/filing-requirements-drilling-canadian-arctic/)
* [Filing Requirements for Onshore Drilling Operations Involving Hydraulic Fracturing](/en/about/acts-regulations/other-acts/filing-requirements-onshore-drilling/)
* [Hearing Process Handbook](/en/applications-hearings/participate-hearing/hearing-process/)
* [Land Matters Guide](/en/consultation-engagement/land-matters-guide/)
* [Living and Working Near Pipelines (brochure)](/en/safety-environment/damage-prevention/living-working-near-pipelines/)
* [Participant Funding Program Guide](/en/applications-hearings/participate-hearing/hearing-process/participant-funding-program/participant-funding-guide.html)
* [Protecting Canada – Protecting You (Pamphlet)](/en/safety-environment/security/protecting-canada/)
* [Remediation Process Guide](/en/safety-environment/environment/remediation/remediation-process-guide-2020/ "Remediation Process Guide – October 2020")
* [Responding to Emergencies](/en/safety-environment/emergency-management/responding-emergencies/responding-emergencies.html)
* [Studying and Sampling Well Materials from Frontier Wells](/en/about/acts-regulations/other-acts/canada-oil-gas-operations-act/studying-sampling-well-materials-from-frontier-wells.html)
* [The CER, Energy Projects, and Indigenous Peoples – brochure](/en/consultation-engagement/land-matters-guide/brochures/cer-energy-projects-indigenous-peoples/)
* [The CER, Energy Projects and You – brochure](/en/consultation-engagement/land-matters-guide/brochures/cer-energy-projects-you/)
...
* The Government of Canada encourages the release of information through requests outside of the formal request processes. To make an informal request, contact:
  ...
  [Website](/index.html)
  ATIPOffice-BureauAIPRP@cer-rec.gc.ca
* You may also wish to search summaries of completed access to information requests for which Canada Energy Regulator has already provided responses as this information may be more easily obtained. You may also wish to review available open data regarding the CER [completed Access to Information (ATI) summaries](https://open.canada.ca/en/search/ati).
* Canada Energy Regulator conducts privacy impact assessments (PIAs) to ensure that privacy implications will be appropriately identified, assessed and resolved before a new or substantially modified program or activity involving personal information is implemented. Summaries of completed PIAs [Summaries of completed PIAs](/en/about/open-government/transparency/privacy-impact-assessment-summaries/) are available.
...
[Contact Us – General Information](/en/about/contact/)
...
* ### [About Us](/en/about/index.html)
  ...
  + [Accessibility](/en/about/accessibility/index.html)
  + [Who we are and what we do](/en/about/who-we-are-what-we-do/index.html)
    - [Our People](/en/about/who-we-are-what-we-do/people.html)
    - [Our Responsibilities](/en/about/who-we-are-what-we-do/responsibility/index.html)
    - [Our Strategic Plan](/en/about/who-we-are-what-we-do/strategic-plan/index.html)
    - [Our Work](/en/about/who-we-are-what-we-do/our-work.html)
    - [Governance](/en/about/who-we-are-what-we-do/governance/index.html)
    - [Organization and Structure](/en/about/who-we-are-what-we-do/organization-structure/index.html)
    - [Cost Recovery](/en/about/who-we-are-what-we-do/cost-recovery/index.html)
    - [CER Time Limits and Service Standards](/en/about/who-we-are-what-we-do/cer-time-limits-and-service-standards.html)
  + [How we regulate](/en/about/how-we-regulate/index.html)
    - [Regulatory Framework 101](/en/about/how-we-regulate/regulatory-framework-101/index.html)
    - [Guidance](/en/about/how-we-regulate/guidance/index.html)
    - [Designated Authorities 101](/en/about/how-we-regulate/designated-authorities-101.html)
    - [Plans for the Regulatory Framework](/en/about/how-we-regulate/plans-for-regulatory-framework/index.html)
    - [Regulatory Cooperation](/en/about/how-we-regulate/regulatory-cooperation/index.html)
  + [Contact Us](/en/about/contact/index.html)
    - [Confidential Disclosure (Whistleblower) Process](/en/about/contact/confidential-disclosure-whistleblower/index.html)
  + [Acts and Regulations](/en/about/acts-regulations/index.html)
    - [List of Acts and Regulations](/en/about/acts-regulations/list-acts-regulations/index.html)
    - [CER Act – Regulations and Related Documents](/en/about/acts-regulations/cer-act-regulations-guidance-notes-related-documents/index.html)
    - [COGOA and other Acts – Regulations and Related Documents](/en/about/acts-regulations/cogoa-other-acts-regulations-guidance-notes-related-documents/index.html)
    - [Forward Regulatory Plan](/en/about/acts-regulations/forward-regulatory-plan/index.html)
    - [Cooperative Agreements](/en/about/acts-regulations/other-acts/cooperative-agreements/index.html)
  + [Careers](/en/about/careers/index.html)
    - [Benefits of working at the CER](/en/about/careers/benefits-cer.html)
    - [How Do I Apply?](/en/about/careers/how-do-you-apply/index.html)
    - [Career Opportunities](/en/about/careers/career-opportunities/index.html)
    - [Student Hiring](/en/about/careers/student-hiring/index.html)
  + [Newsroom](/en/about/news-room/index.html)
    - [News Releases](/en/about/news-room/news-releases/index.html)
    - [Decisions in Brief](/en/about/news-room/decision-in-brief/index.html)
    - [Fact Sheets](/en/about/news-room/fact-sheets/index.html)
    - [Videos](/en/about/news-room/videos/index.html)
    - [Media Accreditation and Guidelines](/en/about/news-room/media-accreditation-guidelines/index.html)
    - [What's New Archives](/en/about/news-room/whats-new/index.html)
    - [Feature Articles](/en/about/news-room/feature-articles/index.html)
  + [North and offshore](/en/about/north-offshore/index.html)
    - [What we regulate in the north and offshore](/en/about/north-offshore/what-we-regulate.html)
    - [Offshore drilling](/en/about/north-offshore/offshore-drilling.html)
    - [Seismic in a marine environment](/en/about/north-offshore/seismic-marine.html)
    - [Significant or commercial discovery](/en/about/north-offshore/significant-commercial-discovery.html)
    - [Access to information or well material](/en/about/north-offshore/access-information.html)
    - [Active operating licences](/en/about/north-offshore/active-operating-licences.html)
    - [Services agreements](/en/about/north-offshore/services-agreements.html)
    - [Research, statistics, and assessments](/en/about/north-offshore/statistics/index.html)
    - [Archived public documents](/en/about/north-offshore/archived-public-documents.html)
  + [Publications and Reports](/en/about/publications-reports/index.html)
  + [Open Government](/en/about/open-government/index.html)
    - [Transparency](/en/about/open-government/transparency/index.html)
  + [CER Library](/en/about/library/index.html)
    - [Contact Us - CER Library](/en/about/library/contact.html)
    - [Requests for Publications](/en/about/library/requests-publications/index.html)
    - [View north and offshore data and well history](/en/about/library/north-offshore-data.html)

##### We're looking to improve our website to serve you better.

Please help us by completing [this survey](https://forms.office.com/r/Jmj6KYkEwt).

## Menu

* [Terms and conditions](/en/terms-conditions.html)
* [Transparency](/en/about/open-government/transparency/index.html)
* [Accessibility](/en/about/accessibility/index.html)
...
### [News](/en/about/news-room/index.html)

* [What's New](/en/about/news-room/whats-new/index.html)
* [News Releases](/en/about/news-room/news-releases/index.html)
* [Videos](/en/about/news-room/videos/index.html)

### [Contact us](/en/about/contact/index.html)

* [Report an incident](https://apps.cer-rec.gc.ca/ERS/Home/Index/)
* [Confidential disclosure](/en/about/contact/confidential-disclosure-whistleblower-process/index.html)
* [Request publications](/en/about/library/requests-publications/index.html)

### [Stay connected](/en/terms-conditions.html#s7)

* [RSS Feeds](/en/rss/rss.html)
* [X](https://twitter.com/CER_REC)
* [Facebook](https://www.facebook.com/CER.REC)
* [YouTube](https://www.youtube.com/c/CanadaEnergyRegulator)
...
* [Jobs](https://www.canada.ca/en/services/jobs/opportunities/government.html)
* [Canada.ca](https://www.canada.ca/en.html)

[Top of Page](#wb-cont)

![Canada.ca](/Templates/wet4-gcwu/assets/wmms-blk.svg)
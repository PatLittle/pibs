...
* ## Sélection de la langue
  ...
  + [English](infosource-eng.html)

## Recherche et menus

* [Recherche et menus](#mb-pnl "Recherche et menus")

[Agence des services frontaliers du Canada](/menu-fra.html)
...
* [Voyageurs](/travel-voyage/menu-fra.html)
* [Importation et exportation](/comm-fra.html)
* [Sécuriser la frontière](/security-securite/safety-surete-fra.html)
* [Publications](/publications/menu-fra.html)

## Vous êtes ici :

1. [Accueil](/menu-fra.html)
2. [à propos de l'ASFC](/agency-agence/menu-fra.html)
3. [AIPRP](/agency-agence/reports-rapports/pia-efvp/atip-aiprp/menu-fra.html "L'accès à l'information et la protection des renseignements personnels")

# L'accès à l'information et la protection des renseignements personnels Renseignements sur les programmes et les fonds de renseignements (anciennement Info Source) Agence des services frontaliers du Canada

## Table des matières

* [Renseignements généraux](#s1)
  + [Présentation](#s1a)
  + [Historique](#s1b)
  + [Responsabilités](#s1c)
* [Fonctions, programmes et activités de l'institution](#s2)
  + [Évaluation des risques](#s2a)
  + [Renseignement](#s2b)
  + [Ciblage](#s2c)
  + [Filtrage de sécurité](#s2d)
  + [Partenariats sûrs et fiables](#s2e)
  + [Voyageurs fiables](#s2f)
  + [Négociants fiables](#s2g)
  + [Détermination de l'admissibilité](#s2h)
  + [Mode routier](#s2i)
  + [Mode aérien](#s2j)
  + [Mode ferroviaire](#s2k)
  + [Mode maritime](#s2l)
  + [Points d'entrée postaux](#s2m)
  + [Expéditions de faible valeur par service de messagerie](#s2n)
  + [Enquêtes criminelles](#s2o)
  + [Exécution de la loi en matière d'immigration](#s2p)
  + [Enquêtes en matière d'immigration](#s2q)
  + [Détentions](#s2r)
  + [Audiences en matière d'immigration](#s2s)
  + [Renvois](#s2t)
  + [Recours](#s2u)
  + [Gestion du commerce et des revenus](#s2v)
  + [Antidumping et compensation](#s2w)
  + [Politique commerciale](#s2x)
  + [Conformité commerciale](#s2y)
  + [Services internes](#s2z)
  + [Manuels](#s2aa)
* [Renseignements supplémentaires](#s3)
  + [Salle de lecture](#s3a)
...
* Naviguez dans la [liste des institutions fédérales](https://www.canada.ca/fr/secretariat-conseil-tresor/services/acces-information-protection-reseignements-personnels/acces-information/renseignements-programmes-fonds-renseignements/sources-renseignements-gouvernement-federal-fonctionnaires-federaux.html) pour en apprendre davantage sur leurs programmes, leurs activités et leurs fonds de renseignements, y compris les catégories de documents et les fichiers de renseignements personnels.
...
* [Catégories de documents ordinaires](https://www.canada.ca/fr/secretariat-conseil-tresor/services/acces-information-protection-reseignements-personnels/acces-information/renseignements-programmes-fonds-renseignements/categories-documents-ordinaires.html) : Il s'agit des descriptions de tous les documents créés et utilisés pour appuyer les services internes.
* [Fichiers de renseignements personnels ordinaires](https://www.canada.ca/fr/secretariat-conseil-tresor/services/acces-information-protection-reseignements-personnels/acces-information/renseignements-programmes-fonds-renseignements/fichiers-renseignements-personnels-ordinaires.html) : Il s'agit de descriptions de renseignements personnels, contenus dans des documents, qui sont recueillis et utilisés pour appuyer les services internes.
...
* **Numéro de dossier** : ASFC ENF 137
...
* **Renvoi au document nº** : [ASFC ENF 137](#enf_137)
...
* **Numéro de dossier** : ASFC ENF 122
...
* **Numéro de dossier** : ASFC ENF 1401
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ENF 137](#enf_137), [ASFC ENF 1401](#enf_1401)
...
* **Numéro de dossier** : ASFC ENF 108
...
* **Numéro de dossier** : ASFC ENF 117
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ENF 117](#enf_117)
...
* **Numéro de dossier** : ASFC ENF 118
...
* **Numéro de dossier** : ASFC ENF 115
...
* **Numéro de dossier** : ASFC ENF 111
...
* **Numéro de dossier** : ASFC ADM 138
...
* **Numéro de dossier** : ASFC ENF 109
...
* **Numéro de dossier** : ASFC ENF 113
...
* **Numéro de dossier** : ASFC ENF 114
...
* **Numéro de dossier** : ASFC ADM 130
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 130](#adm_130)
...
* **Numéro de dossier** : ASFC ENF 133
...
* **Numéro de dossier** : ASFC ENF 104
...
* **Numéro de dossier** : ASFC ENF 121
...
* **Types de documents** : Les formulaires, les manuels, les politiques, les protocoles d'ententes et les historiques de passage et d'exécution de la loi.
* **Numéro de dossier** : ASFC ENF 129
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ENF 129](#enf_129)
...
* **Numéro d'AD**D : 2015-008
* **Renvoi au document** : [ASFC ENF 129](#enf_129)
...
* **Numéro de dossier** : ASFC ENF 132
...
* **Numéro de dossier** : ASFC ENF 134

#### Programme d'inspection du mode aérien – Catégorie de documents

* **Numéro de dossier** : [ASFC ENF 121](#enf_121)
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ENF 121](#enf_121), [ASFC ENF 129](#enf_129), [ASFC ENF 132](#enf_132), [ASFC ENF 134](#enf_134)
...
* **Numéro de dossier** : ASFC ENF 100

#### Élaboration des systèmes (Directions générales des programmes et des opérations)

* **Numéro de dossier**: [ASFC ENF 137](#enf_137)

#### Système intégré d'exécution des douanes (SIED) – Fichier de renseignements personnels

* **Renvoi au document nº** : [ASFC ENF 137](#enf_137)
* **Numéro de fichier** : [ASFC PPU 016](#ppu_016)
...
* **Numéro de dossier** : ASFC ADM 115
...
* **Numéro de dossier** : ASFC ADM 113

#### Cotation harmonisée des risques et Données commerciales préalables (CHR-DCP) – Catégorie de documents

* **Numéro de dossier** : [ASFC ENF 109](#enf_109)
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 132](#adm_132)
...
* **Numéro de dossier** : ASFC ENF 101
...
* **Numéro de dossier** : ASFC ENF 119
...
* **Numéro de dossier** : ASFC ENF 112
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC BPD 1101](#bpd_1101)
...
* **Numéro de dossier** : ASFC ENF 116
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ENF 116](#enf_116)
...
* **Numéro de dossier** : ASFC ENF 124
...
* **Numéro de dossier** : ASFC ENF 102
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ENF 102](#enf_102)
...
* **Numéro de dossier** : ASFC ENF 105
...
* **Numéro de dossier** : [ASFC ENF 129](#enf_129)

#### Le traitement des voyageurs - Fichier de renseignements personnels

* **Renvoi au document nº** : [ASFC ENF 129](#enf_129)
* **Numéro de référence du ficher** : [ASFC PPU 1101](#ppu_1101)

#### Programme d'examen des conteneurs maritimes

* **Numéro de dossier** : [ASFC ENF 132](#enf_132)

#### Programme de détection de la contrebande dans le mode ferroviaire

* **Numéro de dossier** : [ASFC ENF 134](#enf_134)

#### Dossiers du service du renseignement des douanes

* **Renvoi au document nº** : [ASFC ENF 121](#enf_121), [ASFC ENF 129](#enf_129), [ASFC ENF 132](#enf_132), [ASFC ENF 134](#enf_134)
* **Numéro de fichier** : [ASFC PPU 015](#ppu_015)
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC OPS 101](#ops_101)
...
* **Numéro de dossier** : ASFC ADM 131
...
* **Numéro de dossier** : ASFC ADM 104
...
* **Numéro de dossier** : ASFC ENF 106
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ENF 106](#enf_106)
* **Enregistrement (SCT)** : 20140078
* **Numéro du fichier** : ASFC PPU 1404

#### Programme de biométrie - Fichier de renseignements personnels

* **Description :** Cette banque décrit l'information utilisée pour soutenir le programme de biométrie. Cela inclut les demandes de permis d'études, de travail ou de séjour temporaire provenant de certaines nationalités à certains points d'entrée ainsi que la vérification biométrique d'identité des voyageurs inscrits à l'entrée au Canada. Les renseignements personnels peuvent inclure le nom, les renseignements biométriques, le statut de citoyenneté, la date de naissance, d'autres numéros d'identification, les attributs physiques et le lieu de naissance.
* **Note :** Les informations peuvent être stockées dans les systèmes / bases de données internes suivants : Base de données d'identité biométrique des voyageurs (BDIBV), le Système mondial de gestion des cas (SMGC) (photo), système d'identification en temps réel (SITR)
* (empreintes digitales) et l’Historique des Passages (résultats de vérification photo et d'empreintes digitales).
* **Catégorie d'individus :** Des voyageurs inscrits biométriquement à l'étranger, au Canada ou à un POE dans le cadre du Programme de biométrie.
* **Objectif :** Les renseignements personnels servent à administrer le programme de biométrie et à établir l'identité des ressortissants étrangers à un point d'entrée canadien. Les renseignements personnels sont recueillis conformément aux articles 10.01 et 16 de la Loi sur l'immigration et la protection des réfugiés et à l'article 12.1 du Règlement sur l'immigration et la protection des réfugiés.
* **Usages constants :** L'information peut être utilisée ou divulguée à des fins suivantes : application de la loi, rapport à la haute direction, sécurité et gestion de l'identité. Les informations biographiques et biométriques sur les pays étrangers peuvent également être partagées avec les officiers régionaux de renseignement / les opérations de ciblage du renseignement pour aider à déterminer l'admissibilité des voyageurs; voir CBSA PPU 035.
* **Normes de rétention et d'élimination :** Les dossiers seront conservés pendant 15 ans à partir de la collecte biométrique la plus récente et seront détruit systématiquement après 15 ans ou lors de l'octroi de la citoyenneté canadienne. Pour les personnes jugées inadmissibles en vertu des articles 34-37 de la Loi sur l'immigration et la protection des réfugiés, les empreintes digitales être retenu jusqu'à ce que la personne atteigne l'âge de 100 ans, puis soit détruit.
* **Numéro RDA :** 2015/008
* **Catégorie de dossier associée :** CBSA 1ER 006, ASFC ADM 132
* **TBS Registration :** 20220017
* **Numéro de banque :** CBSA PPU 1203
...
* **Numéro de dossier** : ASFC ADM 107
...
* **Numéro de dossier** : ASFC ADM 108
...
* **Numéro de dossier** : ASFC ADM 109
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 107](#adm_107), [ASFC ADM 108](#adm_108), [ASFC ADM 109](#adm_109)
...
* **Numéro de dossier** : ASFC ADM 110
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 110](#adm_110)
...
* **Numéro de dossier** : ASFC ADM 117
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 117](#adm_117)
...
* **Nota** : Ces documents peuvent être trouvés dans les systèmes suivants : le Système global d'inscription en ligne (SGIL), le Système intégré des douanes (SID), le Centre d'information de la police canadienne (CIPC), le [Système de récupération de renseignements judiciaires](http://atlas/istb-dgist/services/hq-it-ac-ti/apl-lpa/software-logiciel/apl_lob_fra.asp#srrj "Français - Version française de ce titre") (SRRJ), le Système de soutien des opérations des bureaux locaux (SSBOL), le National Crime Information System (NCIS), le Système intégré d'exécution des douanes (SIED), la Composante d'inscription globale (CIG), la Composante d'évaluation des risques (CER), le Système global d'inscription des États-Unis (SGI), et dans le portail web de la CVAA.
...
* **Numéro de dossier** : ASFC ADM 100
...
* **Numéro de dossier** : ASFC IST 004
...
* **Renvoi au document nº** : [ASFC IST 004](#ist_004)
...
* **Numéro de dossier** : ASFC IST 005
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC IST 005](#ist_005)
...
* **Numéro de dossier** : ASFC ADM 120
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 120](#adm_120)
...
* **Numéro de dossier** : ASFC IST 002
...
* **Numéro de dossier** : ASFC IST 003
...
* **Numéro de dossier** : ASFC ADM 111
...
* **Numéro de dossier** : ASFC ADM 116
...
* **Numéro de dossier** : ASFC ADM 105
...
* **Numéro de dossier** : ASFC ADM 106
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 105](#adm_105), [ASFC ADM 106](#adm_106)
...
* **Numéro de dossier** : ASFC ADM 134

#### Surveillance audiovisuelle ouverte – Catégorie de documents

* **Numéro de dossier**: [ASFC BPD 1101](#bpd_1101)

#### Surveillance audiovisuelle ouverte – Fichier de renseignements personnels

* **Renvoi au document nº** : [ASFC BPD 1101](#bpd_1101)
* **Numéro de fichier** : [ASFC PPU 1104](#ppu_1104)
...
* **Numéro de dossier** : ASFC BPD 1102
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC BPD 1102](#bpd_1102)
...
* **Numéro de dossier** : ASFC ADM 124
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 124](#adm_124)
...
* **Renvoi au document nº** : [ASFC ENF 129](#enf_129)
* **Numéro de fichier** : [ASFC PPU 1101](#ppu_1101)
...
* **Renvoi au document nº** : [ASFC ENF 129](#enf_129)
* **Numéro de fichier** : [ASFC PPU 1202](#ppu_1202)
...
* **Numéro de dossier** : ASFC ADM 121
...
* **Numéro de dossier** : ASFC ADM 125
...
* **Numéro de dossier** : ASFC ADM 127
...
* **Numéro de dossier** : ASFC ADM 123
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 123](#adm_123)
...
* **Numéro de dossier** : ASFC ADM 129
...
* **Numéro d'AD**: 2015/008
* **Renvoi au document nº** : [ASFC ADM 129](#adm_129)
...
* **Numéro de dossier** : ASFC ENF 125
...
* **Numéro de dossier** : ASFC ADM 133
...
* **Numéro de dossier** : ASFC ENF 110
...
* **Numéro de dossier** : ASFC OPS 102
...
* **Numéro de dossier** : ASFC ENF 135
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ENF 135](#enf_135)
...
* **Numéro de dossier** : ASFC ADM 128
...
#### Le programme Information préalable sur les voyageurs et du dossier passager (IPV et DP) – Catégorie de documents

* **Description** : Cette catégorie décrit les documents relatifs aux programmes IPV et DP.
* **Remarque** : Elle peut comprendre des documents relatifs à l'établissement ou à l'utilisation de systèmes électroniques servant à gérer les programmes ou les bases de données administratives d'exécution de la loi où les données peuvent être sauvegardées. Il s'agit notamment du Système d'information sur les voyageurs (SIPAX), du Système intégré d'exécution des douanes (SIED), du Système de gestion du renseignement (SGR) et du Système mondial de gestion des cas (SMGC) d'Immigration, Réfugiés et Citoyenneté Canada.
* **Types de documents** : Formulaire de demande d'informations IPV et DP du voyageur, notes de service sur les systèmes d'exécution, description du système SIPAX et dossiers d'essai, rapports d'évaluation, informations sur le profil des voyageurs fournies par les transporteurs du secteur commercial, contrôles de conformité, enquêtes et protocoles d'entente.
* **Numéro de dossier** : ASFC IST 001

#### Le programme Information préalable sur les voyageurs et du dossier passager (IPV et DP) – Fichier de renseignements personnels

* **Description** : Cette banque décrit les informations concernant les personnes voulant entrer au Canada. Aux termes de la législation canadienne, tous les transporteurs du secteur commercial sont tenus de fournir l'IPV et le DP pour toutes les personnes se trouvant ou devant se trouver à bord d'un moyen de transport commercial en partance pour le Canada. Dans le cas de l'IPV, les renseignements personnels comprennent le nom, la date de naissance, le sexe, la citoyenneté ou la nationalité, l'information sur le document de voyage, la date et l'heure de départ, la date et l'heure d'arrivée, le point de départ, le point d'arrivée, le code du vol et le numéro du dossier de réservation, s'il y a lieu. Il comprend aussi une référence unique de passager (RUP) qui est attribuée par un transporteur du secteur commercial à chaque voyageur aux fins du processus de traitement des messages d'embarquement autorisé ou non autorisé du programme. En ce qui concerne le DP, les renseignements personnels peuvent inclure, sans s'y limiter, le nom du voyageur, sa réservation et son itinéraire de voyage, par exemple le point d'origine et la destination, les dates et heures de voyage, les informations relatives à la carte de crédit, les informations relatives au programme de fidélisation et l'adresse à laquelle le passager résidera pendant son séjour au Canada.
* **Catégorie de personnes** : Le grand public – notamment les employés des transporteurs du secteur commercial – qui voyage à bord d'un moyen de transport commercial à destination du Canada.
* **But** : Les renseignements personnels sont recueillis conformément à l'article 107.1 de la Loi sur les douanes, du Règlement sur les renseignements relatifs aux passagers (douanes), à l'alinéa 148(1)d) de la Loi sur l'immigration et la protection des réfugiés et de l'article 269 du Règlement sur l'immigration et la protection des réfugiés aux fins de la gestion des programmes IPV et DP, lesquels comprennent une évaluation des risques, notamment une analyse des risques fondée sur des scénarios, et la recherche d'informations relatives à l'exécution de la loi et au renseignement sur les personnes avant leur arrivée au Canada. L'IPV est aussi utilisée dans le cadre de l'Information interactive préalable sur les voyageurs (IIPV). Ce processus permet à l'ASFC d'identifier systématiquement les voyageurs qui pourraient ne pas satisfaire aux exigences documentaires pour entrer au Canada et de communiquer un message d'embarquement autorisée ou non autorisé aux transporteurs aériens qui peuvent, à leur tour, empêcher le voyageur de monter à bord.

  Le Règlement sur la protection des renseignements relatifs aux passagers régit le traitement des données du DP, notamment en ce qui concerne l'accès à celles-ci, leur utilisation, leur conservation et leur communication.
* **Usages compatibles** : Les renseignements peuvent être communiqués à l'interne à des fins de vérification, d'évaluation ou de recherche. Ils peuvent être communiqués à la Gendarmerie royale du Canada (GRC) et au Service canadien du renseignement de sécurité (SCRS) aux fins d'exécution de la loi et d'enquêtes – consulter les Dossiers (GRC PPU 015) et les Dossiers d'enquête (SCRS PPU 045). Les renseignements sur les passagers recueillis dans le cadre du programme IPV et DP de l'ASFC peuvent être communiqués au département de la Sécurité intérieure des États-Unis au cas par cas, en application d'un protocole d'entente visant à faciliter l'examen de personnes à risque élevé qui arrivent par voie aérienne au Canada ou aux États-Unis.
* **Normes de conservation et de destruction**: Les fichiers sont conservés pendant trois ans et demi à partir de la date de réception, puis ils sont détruits. Lorsque les renseignements IPV et DP ont trait à une personne faisant l'objet d'une enquête au Canada, ils sont transférés dans une base de données d'exécution de l'ASFC, y sont conservés pendant une période ne dépassant pas six ans, puis sont détruits.
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC IST 001](#ist_001)
...
* **Numéro de dossier** : ASFC ADM 118
...
* **Numéro de dossier** : ASFC ADM 119
...
* **Numéro de dossier** : ASFC IST 006
...
* **Numéro de dossier** : ASFC ENF 127

#### Sûreté du fret aérien

* **Numéro de dossier** : [ASFC ENF 100](#enf_100)
...
* **Renvoi au document nº** : [ASFC ENF 137](#enf_137)
* **Numéro de fichier** : [ASFC PPU 117](#ppu_117)
...
* **Numéro de dossier** : ASFC ENF 120
...
* **Numéro de dossier** : [ASFC ADM 115](#adm_115)

#### Déclaration du plan des baies

* **Numéro de dossier** : [ASFC ENF 101](#enf_101)
...
* **Numéro de dossier** : ASFC ADM 136
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 136](#adm_136)
...
* **Numéro de dossier** : ASFC ADM 112
...
* **Numéro de dossier** : ASFC ENF 123
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ENF 123](#enf_123)
...
* **Numéro de dossier** : ASFC ENF 107
...
* **Numéro de dossier** : [ASFC ENF 127](#enf_127)
...
* **Numéro de dossier** : ASFC ENF 130
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ENF 127](#enf_127), [ASFC ENF 130](#enf_130)
...
* **Numéro de dossier** : ASFC ENF 103
...
* **Numéro de dossier** : ASFC ADM 135
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 135](#adm_135)
...
* **Numéro de dossier**: ASFC ENF 128
...
* **Normes de conservation et de destruction**: Les dossiers sont conservés pendant 10 ans après la clôture du dossier. Les dossiers graves (articles 34, 35, 36 et 37 de la LIPR) sont conservés pendant 65 ans après la clôture du dossier.
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº**: [ASFC ENF 128](#enf_128)
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº**: [ASFC ENF 128](#enf_128); [ASFC PPU 1107](#ppu_1107); [ASFC PPU 032](#ppu_032)
...
* **Numéro de dossier** : ASFC ENF 136
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ENF 136](#enf_136)
...
* **Numéro de dossier** : ASFC ADM 101
...
* **Numéro de dossier** : ASFC ADM 103
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 101](#adm_101), [ASFC ADM 103](#adm_103)
...
* **Numéro de dossier** : ASFC ADM 102
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 102](#adm_102), [ASFC REC 001](#rec_001)
...
* **Numéro de dossier** : ASFC ADM 137
...
* **Numéro de dossier** : CBSA ADM 1502

#### Grand livre des comptes clients – Fichier de renseignement personnels

* **Description** : Ce fichier contient des renseignements sur les importateurs de marchandises, qui doivent payer des droits et des taxes sur l'importation. Les renseignements personnels peuvent comprendre le nom, les coordonnées et la signature du particulier, la langue préférée, la date de naissance, le statut de citoyenneté, les vérifications criminelles, le code du transporteur, les identifiants des clients y compris le numéro d'entreprise (émis par l'Agence du revenu du Canada) et les informations financières.
* **Remarque** : L'Agence du revenu du Canada reçoit les renseignements personnels comme le nom et le numéro d'entreprise du particulier, qui les corrobore lorsqu'il importe des marchandises à des fins commerciales. Les renseignements peuvent être stockés dans les systèmes ou bases de données internes suivants : Gestion des cotisations et des recettes de l'ASFC (GCRA) SAP S/4HANA de l'ASFC, Système des douanes du secteur commercial (SDSC), Système de traitement des déclarations des voyageurs (STDV), Système de mise en lots, de comptabilisation et rapports du K32 (BARKS) et Régime de sanctions administratives pécuniaires (RSAP).
* **Catégorie de particuliers** : Les particuliers et représentants des importateurs et courtiers; les particuliers et représentants des transporteurs et des entreprises.
* **But** : Les renseignements personnels sont utilisés pour suivre les droits et taxes qui ont été imposés, ainsi que les transactions financières relatives à ces droits et taxes afin d'évaluer si les entreprises répondent ou non à des exigences précises. Les renseignements personnels sont recueillis en vertu de l'art. 17(1) et de l'art. 32(1)(a) de la Loi sur les douanes.
* **Usages compatibles** : Les renseignements peuvent être communiqués à l'interne à l'ASFC avec Sanctions administratives pécuniaires (ASFC PPU 001), Programme des transporteurs et du fret (ASFC PPU 045), Programme des enquêtes criminelles (ASFC PPU 1402), Programme des entrepôts de stockage des douanes (ESD) (ASFC PPU 1405), Courtiers en douane – statut professionnel et qualifié (ASFC PPU 006), Registres des saisies douanières (ASFC PPU 015), Demandeurs de boutiques hors taxes (frontière terrestre) (ASFC PPU 007), Programme d'exportation (ASFC PPU 1103), Programme sur les aliments, les végétaux et les animaux (ASFC PPU 062), Système intégré d'exécution des douanes (SIED) (ASFC PPU 016), Programme de renseignement (ASFC PPU 035), Programme de partenaires en protection (ASFC PPU 200), et Recours (ASFC PPU 005).

  Les informations peuvent également être partagées à l'externe avec l'Agence du revenu du Canada pour le numéro d'entreprise et les comptes d'importation et d'exportation (Numéro d'entreprise et inscription au compte de programme ARC PPU 223 et Décisions et interprétation de l'accise et de la TPS/TVH (Décisions et interprétation de l'accise et de la TPS/TVH ARC PPU 092) lorsque les comptes sont en souffrance ; ainsi que pour les informations liées au service de soutien. En cas de trop-perçu, les informations seront communiquées à Services publics et approvisionnement Canada (Paiements au receveur général TPSGC PCU 712) afin de faciliter le remboursement. Le ministère des Finances pour la formulation ou l'évaluation de la politique fiscale, le ministère de l'Innovation, des Sciences et du Développement économique pour la surveillance du numéro d'entreprise du client et des importations, le Bureau du vérificateur général à des fins de vérification, Statistique Canada pour les données relatives aux importations. Les informations seront partagées avec le Centre canadien de cybersécurité pour les fils de surveillance de la sécurité (Cyberdéfense PPU 007). Les informations peuvent également être utilisées à des fins de sensibilisation, de recherche, d'analyse statistique, d'évaluation de programme et d'établissement de rapports à l'intention de la haute direction.
...
* **Numéro de renvoi au document** : [ASFC ADM 1502](#adm_1502)
...
* **Numéro de dossier** : ASFC ENF 131
...
* **Numéro de dossier** : ASFC ADM 126
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 126](#adm_126)
...
* **Numéro de dossier** : ASFC ADM 139
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 139](#adm_139)
...
* **Numéro de dossier** : ASFC ADM 141
...
* **Types de documents** : Les descriptions de systèmes et les trousses de test, les rapports d'évaluation, les notes d'information, les présentations au Conseil du Trésor, les protocoles d'entente, les ententes sur l'échange de renseignements, les formulaires, les manuels d'instruction et le matériel de formation, les évaluations de la menace et des risques (EMR), les évaluations des facteurs relatifs à la vie privée (EFVP).
* **Numéro de dossier** : ASFC ADM 143
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 143](#adm_143)
...
* **Numéro de dossier** : ASFC ADM 142
...
* **Numéro de dossier** : ASFC ADM 140
...
* **Numéro de dossier** : ASFC ADM 122
...
* **Numéro d'AD** : 2015/008
* **Renvoi au document nº** : [ASFC ADM 122](#adm_122)
...
* **Numéro de dossier** : ASFC ADM 114
...
* [Catégorie de document en matière d'accès à l'information et la protection des renseignements personnel](http://www.infosource.gc.ca/emp/emp02-fra.asp#npd930)
...
* **Programme d'identification interne de l'Infrastructure à clé publique (ICP) – Catégorie de documents**
  ...
  **Identification interne de l'Infrastructure à clé publique (ICP) – Fichier de renseignements personnels**
  ...
  + **Numéro d'AD** : 2015/008
  + **Renvoi au document nº** : [ASFC IST 008](#ist_008)
...
* **Programme du Service des chiens détecteurs (SCD) – Catégorie de documents**
  ...
  + **Numéro de dossier** : ASFC ENF 126
...
* [Catégorie de document en matière de sécurit](http://www.infosource.gc.ca/emp/emp02-fra.asp#npd931)
...
* [Catégorie de document en matière de voyages](http://www.infosource.gc.ca/emp/emp02-fra.asp#npd934)
  + [Fichier de renseignements personnels sur les voyages](http://www.infosource.gc.ca/emp/emp03-fra.asp#pou909)
* **Initiative d'armement – Catégorie de documents**
  ...
  + **Numéro de dossier** : ASFC OPS 100
  ...
  **Rédaction de rapports d'incidents et de recours à la force – Fichier de renseignements personnels**
  ...
  + **Numéro d'AD** : 2015/008
  + **Renvoi au document nº** : [ASFC OPS 100](#ops_100)
  + **Enregistrement (SCT)** : 000006
  + **Numéro de fichier** : ASFC PPU 012
* **Programme d'enquête de sécurité sur le personnel – Catégorie de documents**
  ...
  **Programme d'enquêtes de sécurité sur le personnel – Fichier de renseignements personnels**
  ...
  + **Numéro d'AD** : 2015/008
  + **Renvoi au document nº** : [ASFC CMT 1120](#cmt_1120)
...
Le gouvernement du Canada encourage le dévoilement de renseignements par requêtes informelles. Il vous serait peut-être avantageux de consulter [les sommaires d'Accès à l'information achevés](/agency-agence/reports-rapports/pia-efvp/atip-aiprp/catipr-daic/menu-fra.html) ainsi que [les données ouvertes](http://www.data.gc.ca/default.asp?lang=Fr&n=5175A6F0-1&xsl=datacataloguerecord&metaxsl=datacataloguerecord&formid=A4AA77E3-B7ED-45EA-8E89-D42F50A291A3) de l'Agence des services frontaliers du Canada. Pour obtenir de l'information informellement, une [requête informelle](/agency-agence/reports-rapports/pia-efvp/atip-aiprp/catipr-daic/menu-fra.html) peut être soumise à l'Agence des services frontaliers du Canada.

Vous êtes priés de consulter les instructions pour obtenir de l'information sur les procédures d'accès formel sous la disposition de la [Loi sur l'accès à l'information](/agency-agence/reports-rapports/pia-efvp/atip-aiprp/req-dem-info-fra.html) et [la Loi sur la protection des renseignements personnels](/agency-agence/reports-rapports/pia-efvp/atip-aiprp/req-dem-priv-fra.html). Pour faire une requête formelle:

Postez votre lettre ou votre [formulaire de requête d'Accès à l'information](http://www.tbs-sct.gc.ca/tbsf-fsct/350-57-fra.asp) (Loi sur l'accès à l'information) ou votre [formulaire de requête d'Information personnelle](http://www.tbs-sct.gc.ca/tbsf-fsct/350-58-fra.asp) (Loi sur la protection des renseignements personnels), avec tous les documents nécessaires (comme par exemple, le frais d'application de 5,00$ pour une requête sous la Loi sur l'accès à l'information) à l'adresse suivante:
...
* [Avis](/help-aide/in-ai-fra.html)
* [Transparence](/transparency-transparence/menu-fra.html)

### [À propos de nous](/agency-agence/menu-fra.html)

* [Lois et règlements](/agency-agence/actreg-loireg-fra.html)
* [Possibilités d'emploi](/job-emploi/menu-fra.html)

### [Contactez-nous](/contact/menu-fra.html)

* [Répertoire des bureaux et services de l'ASFC](https://do-rb.cbsa-asfc.cloud-nuage.canada.ca/?lang=fr_CA)
* [Rétroaction](/contact/com-fra.html)
* [Différends, examens et appels](/recourse-recours/menu-fra.html)

### [Nouvelles](/media/menu-fra.html)

* [Communiqués](/media/menu-fra.html)
* [Quoi de neuf](/new-neuf/menu-fra.html)
* [Vidéos](/media/video-fra.html)
...
* [Emplois](https://www.guichetemplois.gc.ca/accueil)
* [Canada.ca](https://www.canada.ca/fr.html)
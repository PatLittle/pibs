...
* [English
  en](/en/security-intelligence-service/corporate/transparency/access-to-information-and-privacy/info-source.html)
...
1. [Canada.ca](/fr.html)
2. [Service canadien du renseignement de sécurité](/fr/service-renseignement-securite.html)
3. [Transparence](/fr/service-renseignement-securite/organisation/transparence.html)
4. [Accès à l’information et protection des renseignements personnels](/fr/service-renseignement-securite/organisation/transparence/acces-a-linformation-et-protection-des-renseignements-personnels.html)
...
* **Programme de filtrage de sécurité**
  **Description :** Le programme de filtrage de sécurité recueille des renseignements personnels sur les personnes visées par une demande de filtrage, et produit et fournit des évaluations de sécurité et des conseils à leur sujet. Il peut s’agir de personnes qui sont ou ont été visées par une demande d’évaluation de sécurité avant ou pendant leur emploi au sein d’un ministère ou d’un organisme fédéral ou provincial ou d’une entreprise privée qui travaille sous contrat pour le gouvernement fédéral, lorsque l’obtention d’une cote de sécurité constitue une condition d’emploi. Des informations semblables sont conservées pour les évaluations de sécurité requises par un gouvernement provincial, un État étranger ou une organisation internationale d’États. Le fichier peut également renfermer des informations sur des personnes visées par une demande de conseil concernant la Loi sur la citoyenneté ou la Loi sur l’immigration et la protection des réfugiés, des vérifications du casier judiciaire ou des antécédents criminels, des résultats de vérifications auprès de bureaux de crédit, des analyses de sécurité, des évaluations de sécurité, des rapports d’enquête, des documents connexes ainsi qu’une indication de la cote de sécurité accordée, des données biographiques et démographiques, des coordonnées, des antécédents scolaires et professionnels, des antécédents de voyage, des renseignements familiaux, des données biométriques, des informations financières, des numéros de passeport ou d’autres documents de voyage, des images, des informations sur des demandes d’immigration et de citoyenneté, des antécédents en matière d’immigration, un identifiant unique du client et des documents d’identité.
  Ces informations peuvent être obtenues pendant les contrôles internes de la qualité, auprès du demandeur, de référents et d’autres contacts, ainsi que dans les sources ouvertes ou auprès de tiers pendant l’enquête de filtrage de sécurité.

  **Catégorie de personnes :** Des personnes pour lesquelles on a demandé au SCRS de fournir une évaluation de sécurité ou un conseil parce qu’elles doivent avoir accès à des informations, à des biens, à des sites ou à des installations du gouvernement du Canada; des personnes qui doivent entrer en contact avec des personnes jouissant d’une protection internationale et des dignitaires et qui doivent avoir accès à des événements spéciaux, à la Cité parlementaire, aux zones réglementées d’aéroports, aux ports maritimes et aux installations nucléaires; des personnes qui doivent obtenir des cartes de proximité dans le cadre du programme canado-américain Expéditions rapides et sécuritaires; les employés désignés des gouvernements provinciaux; les personnes qui sollicitent une admission ou un statut au Canada ou demandent la citoyenneté canadienne. Compte tenu du processus de filtrage, le fichier peut contenir des renseignements personnels sur des personnes qui ne font pas elles-mêmes l’objet d’une évaluation de sécurité.
  **But :**
  Les informations contenues dans ce fichier sont recueillies conformément à l’article 15 de la Loi sur le SCRS pour mener des activités de filtrage de sécurité en vue de produire et de fournir des évaluations de sécurité et des conseils respectivement visés aux articles 13 et 14.
  **Usage compatible :**
  En vertu du paragraphe 19(2) et des articles 13 et 14 de la Loi sur le SCRS, le SCRS peut communiquer ou apparier les informations nécessaires pour préparer et fournir une évaluation de sécurité à des destinataires canadiens et étrangers ou des conseils relatifs à la Loi sur la citoyenneté ou à la Loi sur l’immigration et la protection des réfugiés. Le SCRS peut aussi communiquer les informations ayant trait à la conduite des affaires internationales du Canada au ministre des Affaires étrangères, et les informations touchant la défense du Canada, au ministre de la Défense nationale. Les informations peuvent également être utilisées pour l’appariement de données ou aux fins de la conduite d’enquêtes licites menées relativement à des activités dont il existe des motifs raisonnables de soupçonner qu’elles constituent des menaces envers la sécurité du Canada, et dans d’autres enquêtes licites. De plus, ces informations peuvent être communiquées à l’inspecteur général et à l’Office de surveillance des activités en matière de sécurité nationale et de renseignement, ainsi qu’aux tribunaux compétents. Enfin, ces informations peuvent également servir à des fins de recherche, de formation, de vérifications, de planification, d’évaluation et de statistiques.
  **Normes de conservation et de destruction :**
  Les données contenues dans ce fichier peuvent être conservées de 6 à 50 ans, à compter de la date de la dernière mesure administrative. Une fois que le document a atteint la fin de sa période de conservation, il est détruit conformément à l’autorisation de disposition des documents (ADD). Les documents ayant une valeur archivistique seront examinés et envoyés à Bibliothèque et Archives Canada (BAC) aux fins de conservation. Ceux qui ne répondent pas aux critères de l’ADD ne seront pas envoyés à BAC et seront plutôt détruits.
  **No. ADD :** 2006/001
  **Renvoi au document no. :** SCRS SDS 052
  **Enregistrement (SCT) :** 000835
  **Numéro du fichier :** SCRS PPU 005
...
* **Candidats à un poste au SCRS**
  ...
  **Usages compatibles :** Les renseignements peuvent être versés au fichier d'employés si l'on offre un emploi au postulant et s'il l'accepte. Les compétences du candidat peuvent être évaluées; celui-ci peut être invité, s'il en est jugé capable, à occuper un autre poste, même de niveau différent, que celui qui l'intéressait à l'origine. Les renseignements peuvent servir lors d'enquêtes sur les tentatives d'infiltration dont le SCRS pourrait faire l'objet.Ces informations, y compris des formulaires de filtrage de sécurité remplis, les résultats des vérifications effectuées pour le filtrage de sécurité et les décisions prises par un ministère ou organisme, peuvent être échangées entre responsables de la sécurité de différentes institutions en vue de rendre le filtrage de sécurité transférable et de veiller à ce que des personnes ne soient pas engagées par une autre institution gouvernementale sans tenir compte des circonstances qui ont mené à un éventuel refus ou à une éventuelle révocation par une autre institution. Les informations contenues dans ce fichier pourraient aussi servir de source d’information à lier à d’autres sources d’information en vue de l’exécution par le SCRS du mandat que lui a confié le législateur. Ces renseignements peuvent également servir à des fins de recherche, de vérification, de planification, d'évaluation et de statistiques.
...
* [Catégorie de document en matière de classification des postes](http://www.infosource.gc.ca/emp/emp02-fra.asp#npd919)
  + [Fichier de renseignements personnels sur la dotation](http://www.infosource.gc.ca/emp/emp03-fra.asp#poe920)
* [Catégorie de document en matière d'équité en matière d'emploi et diversité](http://www.infosource.gc.ca/emp/emp02-fra.asp#npd942)
  + [Fichier de renseignements personnels sur l'équité en matière d'emploi et diversité](http://www.infosource.gc.ca/emp/emp03-fra.asp#pou918)
...
* [Catégorie de document en matière de planification des ressources humaines](http://www.infosource.gc.ca/emp/emp02-fra.asp#npd949)
  + [Fichier de renseignements personnels sure la planification des ressources humaines](http://www.infosource.gc.ca/emp/emp03-fra.asp#pou935)
...
* [Catégorie de document en matière de recrutement et dotation](http://www.infosource.gc.ca/emp/emp02-fra.asp#npd920)
  + [Fichier de renseignements personnels sur le code de valeurs et d'éthique de la fonction publique](http://www.infosource.gc.ca/emp/emp03-fra.asp#poe915)
...
* [Catégorie de document en matière de sécurité](http://www.infosource.gc.ca/emp/emp02-fra.asp#npd931)
  ...
  + [Fichier de renseignements personnels sur le contrôle de sécurité du personnel](http://www.infosource.gc.ca/emp/emp03-fra.asp#pou917)
  + [Fichier de renseignements personnels sur les incidents de sécurité](http://www.infosource.gc.ca/emp/emp03-fra.asp#pou939)
...
Le gouvernement du Canada préconise la divulgation d’information au moyen de [demandes informelles](http://www.tbs-sct.gc.ca/tbsf-fsct/350-58-fra.asp). Vous pouvez consulter les demandes d’accès à l’information complétées du Service canadien du renseignement de sécurité. Pour présenter une demande informelle ou pour obtenir plus amples renseignements sur le Service canadien du renseignement de sécurité ses programmes et activités, [contactez-nous](https://www.canada.ca/fr/service-renseignement-securite/organisation/contactez-nous.html "Accès à l'information et de la protection des renseignements personnels").

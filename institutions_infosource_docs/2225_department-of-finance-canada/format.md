# Format Guide: Department of Finance Canada

French name: Ministère des Finances Canada
...
And the value resolves to a bank id like `FIN PPU 100` (`<ORG> <SERIES> <3 digits>`).

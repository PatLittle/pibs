...
* [Français
  fr](/fr/secretariat-conseil-tresor/organisation/transparence/secretariat-conseil-tresor-sources-renseignements-gouvernement-federal-fonctionnaires-federaux-info-source.html)
...
1. [Canada.ca](/en.html)
2. [Treasury Board of Canada Secretariat](/en/treasury-board-secretariat.html)
3. [Transparency: Treasury Board of Canada Secretariat](/en/treasury-board-secretariat/corporate/transparency.html)

# *Info Source*: Treasury Board Secretariat

## On this page

* [Introduction to Info Source](#toc-1)
* [TBS institutional functions, programs and activities](#toc-2)
* [Archived programs and activities](#toc-3)
* [Classes of personal information](#toc-4)
* [Manuals](#toc-5)
* [Additional information](#toc-6)
...
* [Treasury Board of Canada Secretariat mandate](/en/treasury-board-secretariat/corporate/mandate.html)
* [Departmental Plans](/en/treasury-board-secretariat/services/planned-government-spending/reports-plans-priorities.html)
* [Departmental Results Reports](/en/treasury-board-secretariat/services/departmental-performance-reports.html)

## TBS institutional functions, programs and activities

In this section

* [1. Core responsibility: spending oversight](#sec-2-1)
* [2. Core responsibility: administrative leadership](#sec-2-2)
* [3. Core responsibility: employer](#sec-2-3)
* [4. Core responsibility: regulatory oversight](#sec-2-4)
...
1. Government Acquisitions and Public Services Directorate
2. Central Agencies and Shared Services Directorate
...
* Administrative Tribunals Support Services of Canada (ATSSC)
...
* Disaster Financial Assistance Arrangements program (Public Safety Canada)Emergency Management (DFAA)
...
* Passport Canada
* Office of the Director of Public Prosecution Service of Canada (ODPP)
...
1. Defence, International Affairs and Justice Division
2. Safety, Security and Immigration Division
...
* Advice provided to Cabinet committee
* Application
* Form
* List
* Minutes
...
1. Indigenous and Health
2. Employment and Social Development, and Equality, Heritage, Housing and Veterans
...
The Expenditure Data, Analysis, Results and Reviews Program has three core divisions to support Parliament:

1. Expenditure Analysis and Compensation Planning Division
2. Expenditure Strategies and Estimates Division
3. Results Division
...
The division conducts research and analysis to support federal government compensation planning, collective bargaining and research in support of human resources policy development.
...
The division also conducts research and policy analysis to support the design and implementation of departmental and horizontal program reviews and supports the parliamentary assessment of spending plans.
...
The division also advises on the use of results information in horizontal program evaluation and on promoting the use of quantitative impact assessment methodologies for the Government of Canada’s business innovation and growth support programs.
...
The sub-program works to strengthen financial management across the federal public service. The sub-program’s objectives are to promote sound stewardship and value for money and provide direction on standardizing the management of public resources, including in the areas of financial management, charging and fees, across the Government of Canada.
...
The primary legislation issuing program authority is the [*Financial Administration Act*](http://laws-lois.justice.gc.ca/eng/acts/F-11/), with additional legislative instruments such as the *Service Fees Act* supporting specific areas such as charging and fees.
...
Supports the Treasury Board and senior management officials by:

* providing advice, interpretation and assessment of compliance with the *Policy on Transfer Payments* and *Directive on Transfer Payments*.
* supporting departmental capacity through the development of guidance materials and renewal of policy instruments.
...
##### 2.1.2 Investment management initiatives

**Program description**

The Investment Management sub-program aims to strengthen the management of assets and acquired services within the Government of Canada through the development and implementation of policy instruments governing procurement, real property, materiel management, investment planning, and project management and costing.

Through its policies, advice, support and oversight (monitoring, performance measurement and reporting), the Investment Management sub-program assists federal departments and agencies in providing value for money and sound stewardship in the management of their investments.

The Investment Management sub-program also strengthens the professional capacity of the procurement, materiel management, project management, costing and real property communities throughout the public service through a range of capacity-building and community development initiatives.

**Sub-program official**

Assistant Comptroller General, Investment Management Sector

**Investment and Costing Management Directorate**

**Description**

The Investment and Costing Management Directorate develops and interprets policies, directives and develops guidance on investment planning, project and program management real property. The directorate supports the real property and costing communities through guidance and training.
...
* Briefing notes and other notes
* Business cases
* Correspondence
...
**Procurement and Materiel Directorate**

**Description**

The Procurement, Materiel Directorate is responsible for the development and interpretation of directives and guidelines on the management of procurement and materiel.
...
* supporting training
* supporting the Departmental Audit Committee appointment process and tenure management and training
...
1. excellence in technology and operations, which includes a risk-free technical landscape and modern, flexible, people-centric practices
2. simpler, more reliable digital services and programs supported by government-wide data integration and management
3. policies and frameworks designed for a modern, secure and privacy-enabled digital government
4. empowered employees with optimized and enhanced digital talent across the Government of Canada, recognizing that digital talent across Canada is in high demand.
...
* exercising oversight and publishing government-wide requirements for the online publication of *Info Source* for government institutions subject to the *Access to Information Act*
...
* coordinating implementation of open government across Canada with provinces and territories and in collaboration with international partners
...
* Planning materials for events, documentation for internal and external consultations, working groups and committees, agendas, meeting minutes, records of discussion within the domestic and international open government and ATIP communities, the Access to Information and Open Government Executive Committee, and the Open Government Coordinators Working Group
...
* user profile, including a meaningless but unique number (MBUN) as user ID, name and contact information
...
System use data includes internal Internet Protocol address and information on transactions conducted, including date, time duration and nature of the transaction.
...
The Digital Policy Division is the government policy centre for the Treasury Board *Policy on Service and Digital*. The division undertakes policy development and provides interpretation and advice to support the Chief Information Officer of Canada and departmental implementation. The division provides government-wide functional leadership on digital and service policy and performance, including capacity-building, advice and guidance in the conduct, use and advancement of performance practices.

The division also supports the implementation of the President’s mandate for digital transformation and is the policy lead for Canada’s Digital Standards, including facilitating coordination with other jurisdictions.

The division also leads the OCIO Data Strategy, covering the enterprise data, standards and reporting required to implement the Performance Measurement Framework for the *Policy on Service and Digital*.

The division collects service data and results information from departments to support public reporting. The division conducts assessments of departmental service management practices and performance where they intersect with the *Policy on Service and Digital*.
...
**RDA number:** 2010/001 **Related record number:** TBS MF 125 **TBS registration:** 005082 **Bank number:** TBS PCE 704
...
* collects and maintains information on departmental IT expenditures to enable a better understanding of IT expenditures; the data is combined with other data to better understand IT program delivery.
...
**Record number:** TBS MF 150

**TBS Application Portal (TAP)**

**Description**

Records related to the administration and management of the TBS Application Portal (TAP) to facilitate secure access to GC applications available through relying parties, including brokering of identification and authentication assertions and claims from identity providers, configuration, management and maintenance of the enterprise security architecture associated with TAP services, and risk management.

**Document types**

**Meeting and collaboration documents**
...
* Submissions
* Treasury Board submission drafts
...
* Architectural design and verification artefacts (for example, reference architecture, technical architecture, detailed service description project dashboards, access control lists, roles and responsibilities matrix, testing plans and results)
* Guidelines
* Manuals and guides
...
* Graphs and diagrams
* Presentations
* Security assessment reports and service authorities to operate letters
* Security standards
...
**Record number:** TBS FM 440

**Treasury Board of Canada Secretariat Application Portal (TAP)**

**Description**

This bank describes information related to identity validation, authentication and role-based access information associated with the Treasury Board Secretariat of Canada (TBS) Application Portal (TAP). Personal information may include the following:

* first name
* last name
* Personal Record Identifier (PRI) or another employee identifier (for example, Service Number)
* date of birth
* email address
...
* Class of individuals
* Government of Canada (GC) employees within the core public administration (CPA)
* Employees within certain non-CPA institutions who are registered for an account and contractors working on behalf of the GC that require access to internal applications and services that are available via the TAP

**Purpose**

Personal information is used to broker identification or authentication requests or responses to internal credential management services (see Internal Credential Management Services Personal Information Bank: SSC PCU 606). Information is also used to validate identity and manage role-based access to applications available via the TAP. Select personal information attributes such as display first name and last name and email address may be optionally updated directly by the GC employee to whom the information relates. The authority to collect this personal information is pursuant to sections 7(1), 11(1) and 29(2) of the *Financial Administration Act (R.S.C., 1985, c. F-11)*. The authority for the collection of auditing and logging information by TAPx and TIH is pursuant to section 161 of the *Financial Administration Act (R.S.C., 1985, c. F-11).*

**Consistent uses**

In the case of suspected security or privacy breaches, information may be shared with departmental security and access to information and privacy officials (see Security Incidents and Privacy Breaches Personal Information Bank: PSU 939).

For suspected criminal activity, information may also be disclosed to the Royal Canadian Mounted Police for investigation purposes (see Operational Case Records Personal Information Bank: RCMP PPU 005).

Information may also be used to monitor audit trails regarding identity verification, authentication and role management usage, and for evaluation reporting and statistical purposes (see Electronic Network Monitoring Logs Personal Information Bank: PSU 905).

**Retention and disposal standards**

Personal information will be retained for a minimum of two years after the last administrative action and will follow the disposition standards set out by Library and Archives Canada.

**Record Disposition Authority (RDA) Number:** 2016/016

**Related Record Number:** TBS FM 440

**TBS Registration:** 20250445
...
The Communications and Federal Identity Policy program sets the requirements that help departments provide information to the public and to Government of Canada employees about government policies, programs, services and initiatives.

The policy covers various communications activities such as advertising, public opinion research, social media and web, publishing, and the use of the Government of Canada’s official symbols. It ensures departments use appropriate communications tools and channels to help meet the diverse information needs of the public.

It also requires departments to communicate in both official languages in a manner that is objective, accurate, non-partisan, timely, accessible, inclusive and in plain language.

The policy outlines requirements to ensure that the Government of Canada and its programs, services, facilities, assets, activities and uniformed officials are clearly identified in Canada and abroad through the consistent use of the government’s official symbols. **Program official**
...
The program supports the use of a consistent and coherent identity of the Government of Canada through the Federal Identity Program. It also provides guidance, policy interpretations and strategic advice to help departments manage their communications activities and corporate identity effectively and efficiently. This includes providing support and outreach activities for the communications community.
...
As the owner and manager of the largest fixed asset portfolio in Canada – with over 30,000 buildings, 20,000 engineered assets such as bridges and dams, and 40,000 vehicles – the Government of Canada has an important role to play in meeting Canada’s climate objectives. The Government of Canada is also the largest public procurer in Canada, buying over $40 billion annually, and can leverage its procurement power to stimulate market demand for low-carbon products (such as low-carbon cement) and Canada’s emerging clean technology sector.

* The Greening Government Strategy, created in 2017 and updated in 2020 and 2024, commits the Government of Canada to transition to net-zero emissions and climate-resilient operations, while also reducing environmental impacts beyond carbon, including reductions in waste and water use and improvements to biodiversity.
...
The mandate of the Treasury Board of Canada Secretariat Centre for Greening Government is to provide leadership toward net-zero emissions, climate-resilient and green Government of Canada operations. The Centre will:

* lead and coordinate federal operations emissions reduction, climate resilience and greening government initiatives
...
* chairs the international Greening Government Initiative
...
* legal obligations as accounting officers to Parliament under the *Financial Administration Act*
...
**Risk and Compliance Process (RCP)**

**Description**

Includes records related to the administration of the Risk and Compliance Process (RCP) that support deputy heads in meeting their accountabilities.

**Document types**

* General information on RCP
* Information on the RCP
* RCP templates and guidance
* RCP Government-wide Report
* RCP presentations
* RCP questions and calculation methodologies

**Disclosure summaries:** No third-party disclosure has occurred.

**Record number:** TBS PM 350
...
This bank contains personal information collected by the Treasury Board of Canada Secretariat (TBS) through the new, modernized Self-Identification (Self-ID) Questionnaire. The information will be used for non-administrative purposes to measure the extent to which the federal public service is representative of the population it serves. The questionnaire is part of the online Self-ID Application (Self-ID App), which is on the Treasury Board Applications Portal (TAP). Employees who are unable to access the online App are asked to complete an Alternative Format Self-ID (AFSI) Questionnaire. Personal information collected through the Self-ID Questionnaire is limited to woman, disability status and type, Indigeneity, racial group, ethnic or cultural origin(s), religion(s) and belief system(s), gender, sexual orientation and 2SLGBTQI+ identities, and other aspects of identity an employee may want to specify. To administer and manage the Self-ID Questionnaire and to create the Self-ID Database and reports, TBS sources limited personal and non-personal human resource information from other systems, such as the pay system (incumbent file), and the myEmployees Application, which may include employee name, Personal Record Identifier (PRI), birthdate, sex at birth, and first official language.

**Class of Individuals**

Employees for whom Treasury Board is the employer under the *Financial Administration Act*, Schedules I and IV (the core public administration).

**Note:** Federal organizations (listed in Schedule V of the *Financial Administration Act*).

* Outside the core public administration may use the Self-ID App upon approval from TBS.

**Purpose**

Information collected through the Self-ID Questionnaire (in all formats) will be entered into a centralized database managed by TBS. The data will be used to analyze the demographics of the core public administration (CPA) and the representation of employment equity groups designated in the *Employment Equity Act* (EEA). The information will be used for non-administrative purposes only. Departments and agencies will use the self-ID data associated with their employees in the Self-ID Database to conduct workforce analysis to determine the composition of their organization. Personal information on woman, disability status and type, indigeneity and racial group is collected through the Self-ID Questionnaire pursuant to subsection 9(1) of the EEA. All other information relevant to a more nuanced understanding of the diversity of the public service is collected through the Self-ID Questionnaire under the authority of paragraphs 7(1)(e) and 11.1(1)(j) of the *Financial Administration Act*.

**Consistent Uses**

Aggregate and anonymous information may be used for purposes of quality assurance and internal audits. Self-ID data may be shared with the Public Service Commission (PSC) to fulfill its *Employment Equity Act* reporting obligations relating to recruitment and staffing processes (Analytical Environment, PSC PCE 761); and aggregate data may be shared with the Canadian Human Rights Commission to support its mandate to audit federal employers for their compliance with the provisions of the EEA. Access to identifiable data in the Self-ID Database that is necessary to generate aggregate data tables for self-ID reporting is strictly limited to the TBS personnel responsible for managing, analyzing or reporting self-ID data for the public service overall. The technical team at TBS is responsible for managing the Self-ID App and the Self-ID Database, and for enabling the generation of statistical analyses and reports that can be accessed through the App. A limited number of departmental self-ID data stewards (three in each department) are responsible for analyzing and reporting self-ID data; however, on a case-by-case basis, access may be granted to departments with a large number of employees for more than three data stewards and/or AFSI stewards as needed. In the case of Alternative Format Self-ID (AFSI) Questionnaires, departments will delegate the task of safeguarding and entering data from these questionnaires to AFSI stewards. AFSI stewards will have access to a data entry portal in the online Self-ID App (when available) but will not have access to the Self-ID Database or to any statistics or reports generated in the App.

**Note:** Identity information collected in the open description of identity question (or in any other open text boxes) will not be included in employment equity reporting, or shared with departments, and will not be transferred to any other response options. TBS will use these responses to help inform updates to the new Self-ID Questionnaire.

**Note:** The Self-ID App may be used as a source of information or for linking data with the following systems: Incumbent Pay system, Extra Duty Reporting System (EDRS), Mobility File, Entitlements and Deductions System (EDSS), Leave Without Pay System (LWOP), Official Languages Information System (OLIS), Leave Reporting System (LRS), Position and Classification Information System (PCIS), and Workforce Adjustment Monitoring System (WFAM), human resource data files of the Public Service Commission, such as the Analytical Environment (PSC PCE 761) and the Applicant Profiles, Applications and Referrals System (PSC PPU 015). The data is also linked with workforce availability data to create departmental reports.

**Retention and Disposal Standards**

Personal information (in all formats) will be retained for at least 2 years and for up to 10 years, following the date of an employee’s departure from the federal public service. Historical monthly snapshots will be retained to allow TBS to conduct historical reporting on underrepresented groups and thereby contribute to the Treasury Board’s fulfillment of its *Employment Equity Act* obligations. Yearly master files are transferred to the Public Service Commission and aggregated data is sent to the Canadian Human Rights Commission to support their respective mandates. Departments and agencies will be able to extract departmental self-ID data as needed and will store and dispose of this information, as well as completed and uploaded AFSI questionnaire data, in accordance with the *Privacy Act*, Privacy Regulations and with relevant TBS and departmental policies on the storage and disposal of records.

**Note:** Personal information that TBS collects through the Self-ID Questionnaire and that departments collect through AFSI questionnaires is stored securely in a (Protected B) environment. The online Self-ID Questionnaire is available in the Self-ID App on the TAP web page. The AFSI questionnaire is distributed, collected, stored and entered in the central TBS database by AFSI stewards in each department. Individuals requesting information described in this bank must provide their full name, PRI and home department (the organization responsible for your pay).

Privacy Impact Assessment: A privacy impact assessment (PIA) in relation to the Self-ID Modernization Project was completed in 2023. An addendum to the Self-ID Modernization Project PIA was completed in 2024 to assess the development of the Alternative Format Self-ID (AFSI) Questionnaire. A summary of the PIA is available online.

**RDA Number:** 2015-001
**Related Record Number:** TBS PM 250 and TBS PM 236 **TBS Registration:** 20230017
**Bank Number:** TBS PCE 760
...
1. First, ERTC supports the Treasury Board in its role as the employer for the core public administration, including Royal Canadian Mounted Police civilian and regular members, to ensure that:
   ...
   * policies are analyzed and revised, as necessary
...
* Providing oversight of plan administrators
...
* Using modern technologies and industry best practices to increase digital service options to plan members

**Plan management and communication**

* Communicating with plan members and providers, including Government of Canada mandates in modern contracts, such as Greening Government, GBA Plus, and the Indigenous Participation Component
* Retendering benefit plan contracts on a cyclical basis
...
Assistant Deputy Minister, Employee Relations and Total Compensation Sector
...
* Occupational health and safety
* Support to occupational health and safety, departmental emergency evacuation coordinators and designated recipients’ communities of practice
...
1. Schedule I
2. Schedule IV: Portions of the Core Public Administration
3. Schedule V: Separate Agencies
...
* Briefing notes and advice to senior management
* Committees
* Correspondence
* Directives
* Guides
...
* HR-to-Pay administration, bargaining agents (unions)
* Policies
* Procedures
* Reports and statistics
* Speaking note
...
* compensation, demographic data and statistical analysis in support of the negotiation process
...
* Collectively bargained allowances and other entitlements

**Compensation and allowances**

* Compensation valuation and comparison: elements, individually, outside practices, valuation, application, implementation
* Pay and collective agreement implementation

**Compensation information and analysis**

* Compensation and statistical analysis: occupational categories and groups
* Compensation information: collective bargaining, reports, personnel management information, attendance, leave, overtime and shift work, extra duty compensation
...
**Retention and disposal standards:** Like Collective Bargaining, this information is retained back to the commencement of collective bargaining.
...
This bank contains representations made by complainants and may include names of complainants, their bargaining agents or legal representatives, as well as the decisions of the Federal Public Sector Labour Relations and Employment Board, contact information, and/or complainants personnel information.
...
Information in the bank is used to manage the files through the recourse process and provide background information for research purposes.

**Retention and disposal standards:** Retained for 10 years following closure of the file and then destroyed. Some samples were transferred to Library and Archives Canada for permanent retention.
...
This bank contains complaints lodged against the Treasury Board and related Canadian Human Rights Commission decisions, as well as those of a tribunal, court or both, if applicable. It may contain names of employees, as well as contact information, employee identification number and/or employee personnel information.
...
Information in the bank is used to manage the files through the recourse process and provide background informationfor research purposes.

**Retention and disposal standards**

**General complaints**

* Complaints related to equal pay for work of equal value are retained for 10 years following closure of the file and then destroyed
* General human rights complaints are retained for 10 years following closure of the file and then destroyed

**Insurance-related complaints**

* Complaints related to disability insurance are retained for 20 years following closure of the file and then destroyed
* Complaints related to the Public Service Health Care Plan are retained for 20 years following closure of the file and then destroyed
* Complaints related to the Public Service Management Insurance Plan are retained for 20 years following closure of the file and then destroyed

**Pension and leave complaints**

* Complaints related to maternity leave without pay are retained for 10 years following closure of the file and then transferred to Library and Archives Canada
* Complaints related to pensions are retained for 25 years following closure of the file and then transferred to Library and Archives Canada

**Group-specific complaints**

* Complaints related to the Hospital Services Group are retained for 25 years following closure of the file and then destroyed
* Complaints related to the Nursing Group are retained for 25 years following closure of the file and then transferred to Library and Archives Canada
...
The Employee Relations and Total Compensation (ERTC) sector implements the *Pay Equity Act* in the core public administration (CPA), Royal Canadian Mounted Police (RCMP) and the Canadian Armed Forces (CAF).
...
This bank contains documentation related to the implementation of the *Pay Equity Act* and pay equity complaints lodged prior to the enactment of the *Pay Equity Act*.
...
**Adjudication: section 209 (*Public Service Labour Relations Act*) references and grievances**

**Description**

This bank contains information on grievances referred to adjudication for which a decision has been received from the Federal Public Sector Labour Relations and Employment Board and/or that were withdrawn by the grievers. It may contain names of grievers, as well as contact information, employee identification number and/or employee personnel information.

**Note:** This has been updated and now covers PIB 750 – Grievances, effective FY 2025–26.
...
This bank maintains records of adjudication decisions, along with the related grievances, including grievances that were submitted for adjudication but were subsequently withdrawn, settled, or otherwise resolved, thereby rendering an adjudication decision unnecessary.
...
This bank contains information and Federal Public Sector Labour Relations and Employment Board decisions on employee requests for extension of time to refer grievances to adjudication. It may contain names of employees, as well as contact information, employee identification number and/or employee personnel information.

**Class of individuals**

This information relates to federal employees (under Schedules I and IV of the *Financial Administration Act*) who are requesting an extension of time to refer their grievances to adjudication.

**Purpose**

The purpose of this bank is to maintain records of employees who have requested an extension of time to refer their grievances to adjudication.

**Consistent uses**

The information in this bank is used for reference and to provide background information for research purposes.

**Retention and disposal standards:** Retained for 10 years following closure of the file and then destroyed. Some samples were transferred to Library and Archives Canada for retention.
...
Information in this bank is provided by the NJC Secretariat to TBS employees who are members of NJC committees who will be hearing grievances relating to specific NJC directives. It is provided, in accordance with the NJC By-Laws (section 15 – Resolution of Grievances), alleged misinterpretations or misapplications of directives that have been the subject of NJC consultations and have been recommended by the NJC Executive to the President of Treasury Board. This information is used by officers of TBS to develop the employer’s position in response to employees’ grievances referred to the NJC.

**Consistent uses**

Information is used for internal research to identify precedents.
...
General information about compensation policy and managerial or confidential positions. This business unit prepares, authorizes, publishes and maintains policies that define terms and conditions of employment, including for certain senior managerial or confidential positions and unrepresented groups and levels.

**Document types**

**Administrative policies and exclusions**

* Compensation policies and associated directives

**Compensation and risk management**

* Pay plans: Policy advice on performance pay administration for certain senior excluded and unrepresented groups and levels

**Others**

* Briefing notes
* Correspondence, including that with the FPSLREB
* Documentation for tribunal appearances – for managerial and confidential positions or grievances
* Notes
...
There are 27 separate agencies named in Schedule V of the *Financial Administration Act*. (Two separate agencies are currently inactive: Canada Investment and Savings as well as Statistics Survey Operations.) They conduct their own negotiations for unionized employees and determine compensation levels for non-unionized employees.
...
* Parks Canada
* Polar Knowledge Canada (listed as Canadian High Arctic Research Station in the  *Financial Administration Act*)
* Social Sciences and Humanities Research Council of Canada
* Staff of the Non-Public Funds – Canadian Forces
* Statistical Survey Operations (inactive)
...
This bank is the prime source of exclusions data for TBS users and is used for monitoring the exclusions process and supporting human resources planning and management, which includes:
...
Strategic Directions and Digital Solutions program has two key responsibilities. First, the program provides strategic directions for people management in the Government of Canada through fostering government-wide excellence in people management and maintaining modern and agile policy frameworks as well as research and experimentation on innovative practices across the public service to manage people effectively in preparation for the future of work.
...
Under the Senior Assistant Deputy Minister, the sector supports deputy heads and heads of human resources with policy advice and guidance to enable an ethical, healthy and high-performing public service. It provides strategic direction and oversight in the areas of:

**Values,** **ethics, and workplace well‑being**

* Administering and promoting the *Values and Ethics Code for the Public Sector*, providing guidance, training and support on related policies, outreach and conflict of interest matters
* Administering and promoting the *Public Servants Disclosure Protection Act*, providing advice and coordinating the tabling of the annual report
* Advancing and supporting priorities and initiatives to promote mental health in the workplace

**People management policies, programs and executive oversight**

* Overseeing executive management functions, including total compensation, organization and classification, talent and performance management, policy interpretation, terms and conditions of employment, and career transitions
* Developing, implementing and monitoring policies and programs related to people management and workplace practices

**Strategic workforce planning, data and evidence‑based decision‑making**
...
Senior Assistant Deputy Minister – Strategic Directions (SD)

Assistant Deputy Minister, Digital Solutions (DS)
...
Records related to the administration, promotion and provision of advice on the *Values and Ethics Code for the Public Sector* and related Treasury Board policies and directives, including the *Directive on Conflict of Interest*:
...
**Disclosure of wrongdoing activities**
...
* support to the Public Servants Disclosure Protection Act Review Task Force
...
The Interchange Canada Reporting Application exists under the authority of s. 7(1)(e) and s.11.1 (.1 (1)(f) of the *Financial Administration Act*, and Treasury Board policy instruments (the Policy on People Management and the Directive on Interchange Canada) to maintain historical records of all persons who have participated in Interchange Canada, to support administration, reporting, and oversight.

**Consistent uses**

Under sections 4.1.5 and 4.2.5 of the Directive on Interchange Canada, departments must record all Interchange assignment information or changes in the Interchange Canada Reporting Portal. This information is used for statistical data analysis and trends forecasting. The Interchange Canada Assignment Opportunity Portal is used to display available assignment opportunities to users inside and outside the Government of Canada.
...
Departments follow Library and Archives Canada’s [Standard record-keeping requirements](/en/library-archives/services/government/information-disposition/management/generic-valuation-tools/internal-services/human-resources-management.html) for common administrative records (for example, finance and the management of human resources). For audit purposes, assignment documentation for participants from personal corporations must be retained for 6 years after the end of the assignment ([section 4.2.30 of the *Directive on Interchange Canada*](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=12553#:~:text=4.2.30,the%20assignment%3B%20and)).
...
The Strategic Policy and Research unit is responsible for supporting departmental integrated strategic planning, reporting, policy development, and research activities for the Office of the Chief Human Resources Officer (OCHRO). It supports government-wide people management strategies, renewal, modernization, and the use of evidence-based decision-making through research and analysis. The function also includes coordination of internal governance, Treasury Board submission support, the Direction on prescribed presence in the workplace and transformation initiatives within OCHRO.

**Document types**

* Departmental Plans and Departmental Results Reports (employer component)
* Integrated business plans and performance information profiles
* Agendas, minutes, and records of decision
* Research plans, strategies, and action plans
* Briefing notes, presentations, speaking materials, and backgrounders
* Reports, datasets, dashboards, and statistics
* Frameworks, guides, policies, and procedures
* Project and transformation plans, documentation, and trackers
* Internal governance committee terms of reference
* Correspondence, summaries, and analytical material
...
**Record number:** TBS PM 355

**Information management**

**Description**

The Workforce Business Intelligence Services (WBIS) unit within Strategic Directions is responsible for managing, extracting, analyzing and sharing the information and data within central agency information systems on the federal public service and the core public administration workforce. As part of managing workforce information, WBIS provides data users with access to micro-data, or they extract and provide users with aggregated unsuppressed and suppressed data based on the user’s needs and in alignment with the Privacy Information Banks. Additionally, WBIS plays a critical role in enabling evidence-based workforce strategic decision-making across the federal public service through their dissemination of data and key findings. WBIS is equally responsible for Employee Surveys such as the Public Service Employee Survey (PSES) and the Student Experience Survey (SES) which provides information to help improve people management practices in the federal public service. Departments and agencies can identify their areas of strength and concern related to topics such as:
...
The survey results track progress over time to help develop and refine action plans.
...
* Mobility file
* Acting Assignment Monitoring System
...
* Nunavut Inuit Affirmation Database
* Official Languages Information System II (OLIS II) - historical data only (prior to 2022)
...
**Disclosure summaries:** TBS has information sharing arrangements (ISA) and memorandums of understanding (MOU) with various organizations and with other sectors within TBS. Below is a list of arrangements recently updated or established:

* A MOU has been signed between TBS and the Public Service Commission of Canada (PSC) that sets conditions and procedures for the release of workforce, employment equity, mobility, official language data by TBS to PSC and by PSC to TBS so that both organizations can complete their legislative requirements.
  + Incumbent System (pay system) (TBS PCE 753)
  + Mobility file (TBS PCE 769)
  + Acting Assignment Monitoring System (no available PIB)
  + Position Classification Information System (TBS PCE 784)
  + Central Index (PWGSC PCU 715)
  + Pay Rate Control file
  + The Analytical Environment (PSC PCE 761)
* An ISA has been signed between TBS and Public Services and Procurement (PSPC) that sets out the conditions and procedures for the release of a data extract with PSPC employee pension information.
  + Incumbent System (pay system) (TBS PCE 753)
  + Penfax (PWGSC PCE 702)
* An MOU has been signed between TBS and the Department of National Defence (DND) that sets out the conditions and procedures for the release of an extract of the mobility file that contains individuals at DND only which will allow DND to conduct audits, evaluations and investigations as it relates to DND public servant employees.
  + Mobility File (TBS PCE 769)
* An MOU has been signed between TBS and the Department of Justice (JUS) that sets out the conditions and procedures for the release of workforce data on federal public service employees in order to allow JUS to administer the Legal Services Client Feedback Survey to the correct participants.
  + Incumbent System (pay system) (TBS PCE 753)
* An ISA has been signed between TBS and The Office of the Superintendent of Financial Institutions Canada that sets out the conditions and procedures for the release of demographic, mobility and accumulated sick leave entitlement information for the core public administration, the Canada Revenue Agency and the Canada Energy Regulator.
  + Incumbent System (pay system) (TBS PCE 753)
  + Mobility file (TBS PCE 769)
  + Leave Reporting System (TBS PM 236)
* An ISA has been signed between TBS-OCHRO-WBIS and TBS, Office of the Comptroller General, Financial Management Sector that sets out the conditions and procedure for the release of aggregated unsuppressed workforce, retirement eligibility, official language, hires, internal mobility, and mobility (departures) data on the Comptrollership classification.
  + Incumbent System (pay system) (TBS PCE 753)
  + Mobility file (TBS PCE 769)
  + Position Classification Information System (TBS PCE 784)
  + The Analytical Environment (PSC PCE 761)
* An ISA has been signed between TBS-OCHRO-WBIS and TBS, Office of Chief Information Officer, Digital Community Management that sets out the conditions and procedure for the release of aggregated unsuppressed workforce, retirement eligibility, official language, hires, internal mobility, and mobility (departures) data on the Information Technology classification.
  + Incumbent System (pay system) (TBS PCE 753)
  + Mobility file (TBS PCE 769)
  + Position Classification Information System (TBS PCE 784)
  + The Analytical Environment (PSC PCE 761)
* An ISA has been signed between TBS-OCHRO-WBIS and TBS, Office of the Chief Human Resources Officer, Enabling Talent Programs Division that sets out the conditions and procedure for the release of aggregated unsuppressed workforce, retirement eligibility, official language, hires, internal mobility, mobility (departures) data and employment equity data on the Executive and Executive equivalent classification groups.
  + Incumbent System (pay system) (TBS PCE 753)
  + Mobility file (TBS PCE 769)
  + Position Classification Information System (TBS PCE 784)
  + The Analytical Environment (PSC PCE 761)
  + Employment Equity Data Bank (TBS PCE 739)
* A two-way ISA has been signed between TBS-OCHRO-WBIS and TBS, Office of the Chief Human Resources Officer, Pay Equity Operations that sets out the conditions and procedures for the release of workforce data to enable TBS to fulfill its obligations to implement the *Pay Equity Act*.
  + Incumbent System (pay system) (TBS PCE 753)
...
**RDA number:** 93/031 **Related record number:** TBS PM 236
**TBS registration:** 002318 **Bank number:** TBS PCE 784
...
Computer-based data: Records are retained for historical reporting and destroyed after the operational needs have expired.
...
1. Claim tombstone data: the basic information about a claim, such as claimant identity (name, personal record identifier), date of claim, claim type, claim outcome, payment made, payment denied, source deductions, net payment. Total retention will be until all claim types have been actioned plus 10 years.
2. Claims supporting data: the information supporting the claim analysis and the claim analysis itself, including any comments made by the review committee and/or subject matter experts. Total retention will be until all claim types are closed plus 10 years.
3. Claims payment data: all information documenting payment of the claim, processing of remittances and appropriation transfers. Total retention will be until all claim types are closed plus 10 years.
4. Payment supporting data: all information related to financial controls associated with payments. Total retention will be until all claim types are closed plus 10 years.
5. Other claim administration data: Other administrative data related to processing of the claim. Retention will be until the claim type is closed plus two years.
6. Other claim payment or tax data: other information specifically related to claimant payments and taxes (for example, gross to net calculation, tax slips, remittance information). Retention will be until the claim type is closed plus six years.
...
**Note:** Due to the recent restructuring of the Office of the Chief Human Resources Officer (OCHRO), the information holdings related to the [Employer Program](https://www.tbs-sct.canada.ca/ems-sgd/edb-bdd/index-eng.html#infographic/program/TBC-BXC08/intro) have been updated. These changes will be included in the next *Info Source* chapter exercise.
...
**Note:** Due to the recent restructuring of the Office of the Chief Human Resources Officer (OCHRO), the information holdings or program activities related to the [Public Service Employer Payments](https://www.tbs-sct.canada.ca/ems-sgd/edb-bdd/index-eng.html#infographic/program/TBC-BXC04/intro) have been updated. These changes will be included in the next *Info Source* chapter exercise.
...
* leading regulatory reviews to improve federal regulations and reduce red tape, such as outdated, duplicative or overly burdensome requirements
* engaging Indigenous peoples and stakeholders, such as the Canadian public, business and other groups, to inform priorities related to the modernization of the regulatory system and reduction of regulatory burden.

The Regulatory Affairs program is further supported by the Red Tape Reduction Office, which aims to accelerate red tape reduction, track and communicate results, and improve accountability and transparency of the regulatory system.
...
* Annual report on federal regulatory management initiatives, including certain information required by the Red Tape Reduction Act
...
* [Acquisitions](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/internal-services.html#acq)
* [Communications Services](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/internal-services.html#comm)
* [Financial Management](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/internal-services.html#fm)
* [Human Resources Management](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/internal-services.html#hrm)
* [Information Management](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/internal-services.html#im)
* [Information Technology](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/internal-services.html#it)
* [Legal Services](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/internal-services.html#ls)
* [Management and Oversight Services](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/internal-services.html#mos)
* [Material](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/internal-services.html#mat)
* [Real Property](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/internal-services.html#rp)
* [Travel and Other Administrative Services](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/internal-services.html#toas)
...
* [Procurement and Contracting Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn912)
  + [Professional Services Contracts Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu912)

**Communications services**

Communications services involve activities undertaken to ensure that Government of Canada communications are effectively managed, well coordinated and responsive to the diverse information needs of the public. The communications management function ensures that the public – internal or external – receives government information and that the views and concerns of the public are taken into account in the planning, management and evaluation of policies, programs, services and initiatives.

* [Communications Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn939)
  + [Internal Communications Persona Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu915)
  + [Public Communications Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu914)

**Financial management services**

Financial management services involve activities undertaken to ensure the prudent use of public resources, including planning, budgeting, accounting, reporting, control and oversight, analysis, decision support and advice, and financial systems.

* [Financial Management Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn914)
* **Disclosure summaries:** A memorandum of understanding has been signed between TBS, the Department of Finance Canada and the Canada Revenue Agency (CRA) that sets conditions and procedures for the release of monies to TBS by way of set-off by the CRA against debts of individuals due to TBS, and for the release of debtor information by TBS to the CRA and the release of taxpayer information by the CRA to TBS.
  + [Accounts Payable Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu931)
  + [Accounts Receivable Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu932)
  + [Acquisition Cards Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu940)
...
They ensure that the human resources operations and programs of the department comply with applicable laws, regulations, policies and plans. It includes activities related to:

* supporting recruitment, staffing and employee compensation processes
* reviewing and assessing job descriptions, classifications and organizational design
* maintaining human resources information systems
* assisting with labour relations and compliance matters
* human resources planning, data analysis, research and reporting
* coordinating organization-wide training and development activities
* delivering employee awards and recognition programs
* managing employee performance and supporting talent development initiatives
* monitoring workplace practices, health and safety compliance
* promoting values, ethics and conflict of interest guidelines
* engaging in equity and inclusion initiatives
* [Classification of Positions Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn919)
  + [Staffing Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse902)
* [Compensation and Benefits Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn941)
  + [Attendance and Leave Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse903)
  + [Pay and Benefits Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse904)
* [Awards (Pride and Recognition) Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn940)
  + [Recognition Program Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse920)
* [Training and Development Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn927)
  + [Training and Development Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse905)
* [Employment Equity and Diversity Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn942)
  + [Employment Equity and Diversity Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse918)
* [Occupational Health and Safety Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn922)
  + [Employee Assistance Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse916)
  + [Harassment Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse919)
  + [Occupational Health and Safety Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse907)

**Labour relations and compliance**

* [Labour Relations Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn926)
  + [*Canadian Human Rights Act* – Complaints Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu933)
  + [Discipline Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse911)
  + [Grievances Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse910)
  + [Harassment Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse919)
  + [Disclosure of Wrongdoing in the Workplace Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu906)
  + [Values and Ethics Codes for the Public Sector and Organizational Code(s) of Conduct Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse915)
* [Recruitment and Staffing Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn920)
  + [Applications for Employment Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu911)
  + [Employee Personnel Record Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse901)
  + [EX Talent Management Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu934)
  + [Personnel Security Screening Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu917)
  + [Staffing Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse902)
  + [Values and Ethics Codes for the Public Sector and Organizational Code(s) of Conduct Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse915)

**Additional records and compliance**

* [Human Resources Planning Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn949)
  + [Human Resources Planning Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu935)
* [Official Languages Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn923)
  + [Official Languages Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse906)
* [Performance Management Reviews Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn946)
  + [Discipline Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse911)
  + [Employee Performance Management Program Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#:~:text=Number%253A%2520PSE%25C2%25A0916-,Employee%2520Performance%2520Management%2520Program,Bank%2520Number%253A%2520PSE%2520912,-Employee%2520Personnel%2520Record)
* [Relocation Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn936)
  + [Relocation Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu910)

**Compliance records from other sectors**

* [Hospitality Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn933)
  + [Hospitality Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu908)
* [Human Resources Planning Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn949)
  + [Workplace Day Care Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse930)
* [Occupational Health and Safety Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn922)
  + [Vehicle, Ship, Boat and Aircraft Accidents Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse908)
...
* [Access to Information and Privacy Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn930)
  + [*Access to Information Act* and *Privacy Act* Requests Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu901)
* [Information Management Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn944)
  + [Library Services Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu936)
...
* [Information Technology Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn932)
  + [Electronic Network Monitoring Logs Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu905)

**Legal services**

Legal services involve activities undertaken to enable government departments and agencies to pursue policy, program and service delivery priorities and objectives within a legally sound framework.

* [Legal services Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn902)
...
* [Cooperation and Liaison Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn904)
  + [*Lobbying Act* Requirements Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu937)
  + [Outreach Activities Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu938)
* [Executive Services Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn943)
  + [Executive Correspondence Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu902)
* [Internal Audit and Evaluation Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn916)
  + [Evaluation Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu942)
  + [Internal Audit Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu941)
* [Planning and Reporting Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn947)
...
* [Materiel Management Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn945)
  + [Vehicle, Ship, Boat and Aircraft Accidents Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse908)
...
* [Real Property Management Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn948)
  + [Real Property Management Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu914a)

**Travel and other administrative services**

Travel and other administrative services include Government of Canada travel services, as well as those other internal services that do not smoothly fit with any of the internal services categories.

* [Administrative Services Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn901)
  + [Parking Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#pse914)
* [Boards, Committees and Council Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn938)
  + [Governor in Council Appointments Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu918)
  + [Members of Boards, Committees and Councils Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu919)
* [Business Continuity Planning Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn928)
  + [Business Continuity Planning Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu903)
* [Disclosure to Investigative Bodies Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn937)
  + [Disclosure to Investigative Bodies Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu913)
* [Proactive Disclosure Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn935)
  + [Hospitality Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu908)
  + [Travel Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu909)
* [Security Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn931)
  + [Disclosure of Wrongdoing in the Workplace Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu906)
  + [Personnel Security Screening Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu917)
  + [Physical Access Controls Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu907)
  + [Security Incidents and Privacy Breaches Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu939)
* [Travel Class of Record](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-classes-records.html#prn934)
  + [Travel Personal Information Bank](/en/treasury-board-secretariat/services/access-information-privacy/access-information/info-source/standard-personal-information-banks.html#psu909)
...
* [Certification Program for the Federal Government Procurement and Materiel Management Communities](#sec-3-1)
...
1. Certified Federal Specialist in Procurement at Levels I and II
2. Certified Federal Specialist in Materiel Management at Level I
...
1. This program is no longer in existence due to the Policy on COVID-19 Vaccination for the Core Public Administration Including the Royal Canadian Mounted Police being rescinded since October 4, 2024.
2. Prior to being rescinded, the Policy was suspended in June 20, 2022.
3. Although the retention period is two years from the last administrative activity, ERTC is maintaining this information bank as there are active grievances and litigation activities relating to the Policy.
...
* [*Access to Information Manual*](/en/treasury-board-secretariat/services/access-information-privacy/access-information/access-information-manual.html)
* [*Federal Identity Program Manual*](http://www.tbs-sct.gc.ca/fip-pcim/man-eng.asp)
* [*Financial Information Strategy Accounting Manual*](https://www.tbs-sct.canada.ca/pol/doc-eng.aspx?id=12182)
* 2023 Federal Greening Government Reporting Guidance
* Strategic Direction for Governments: Information Management – [*Treasury Board Manual*), 1990–97 (25 volumes)](http://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=13586)
...
For general information about making a request for access to information or personal information, refer to [Make an access to information or personal information request](/en/treasury-board-secretariat/services/access-information-privacy/access-information/request-information.html).

To make a request for information online, refer to the [Access to Information and Personal Information Online Request Service](https://atip-aiprp.tbs-sct.gc.ca/welcome).
...
Website: [Treasury Board of Canada Secretariat](/en/treasury-board-secretariat.html)

You may also wish to search summaries of completed access to information requests for which TBS has already provided [responses](https://open.canada.ca/en/search/ati?f%5B0%5D=ss_ati_organization_en:Infrastructure%20Canada&ati%5B0%5D=ati_organization_en:Treasury%20Board%20of%20Canada%20Secretariat), as this information may be more easily obtained. You may also wish to review available open data regarding [TBS](https://search.open.canada.ca/opendata/?page=1&sort=metadata_modified+desc&dataset_type=dataset&owner_org=tbs-sct).

TBS conducts privacy impact assessments (PIAs) to ensure that privacy implications will be appropriately identified, assessed and resolved before a new or substantially modified program or activity involving personal information is implemented. [Summaries of completed PIAs](/en/treasury-board-secretariat/corporate/reports/access-information-privacy-reports-treasury-board-secretariat.html) are available.
...
* [Contact us](/en/treasury-board-secretariat/corporate/contact.html)
* [Forms](/en/treasury-board-secretariat/corporate/forms.html)
